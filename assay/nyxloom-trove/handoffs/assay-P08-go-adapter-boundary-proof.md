...
oracles:
  - id: O1
    ...
    negative: "Treating coverprofile blocks as source lines changes the expected mapping; defaulting true/false or invoking an ambient Go binary makes the missing-tool/fake-parser fixture differ"
    gate: tester-unified
  - id: O2
