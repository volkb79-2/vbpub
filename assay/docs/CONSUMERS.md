...
|---|---|
| `ciu` | vendored pinned zipapp, `tools/assay/assay-6.0.0.pyz` + `.sha256`, invoked through `run-gate.toml`'s `assay_command` |
| `cmru` | vendored pinned zipapp, `tools/assay/assay-6.0.0.pyz` (also its `[orchestration]` release-order pin) |
| `nyxloom` | vendored pinned zipapp, `tools/assay/assay-6.0.0.pyz` |
