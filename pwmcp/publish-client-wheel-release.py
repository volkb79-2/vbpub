...
def main() -> None:
    ...
    latest_notes = os.getenv("PWMCP_CLIENT_LATEST_NOTES", f"{package_name} (latest → {version})")
    ...
    if is_release_version(version):
        ...
        release_notes = os.getenv("PWMCP_CLIENT_RELEASE_NOTES", f"{package_name} {version}")
