...
class PlaywrightMCPConfig:
    ...
    def from_env(cls) -> "PlaywrightMCPConfig":
        ws_url = os.getenv("PWMCP_WS_URL") or os.getenv("WS_URL") or f"ws://localhost:{DEFAULT_WS_PORT}"
        auth_token = os.getenv("PWMCP_AUTH_TOKEN") or os.getenv(ENV_WS_AUTH_TOKEN) or os.getenv(ENV_ACCESS_TOKEN, "")
