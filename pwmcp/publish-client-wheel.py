# !/usr/bin/env python3
# """Publish PWMCP client wheel to GitHub Releases."""
...
#
#
# def build_wheel(project_root: Path, dist_dir: Path, wheel_glob: str) -> Path:
#     if dist_dir.exists():
...
#
#     package_name = os.getenv("PWMCP_PACKAGE_NAME", project_meta.get("name", "pwmcp-client"))
#     dist_name = package_name.replace("-", "_")
#     wheel_glob = os.getenv("PWMCP_WHEEL_GLOB", f"{dist_name}-*.whl")
#
#     wheel_path = build_wheel(project_root, dist_dir, wheel_glob)
#
...
#         "PWMCP_CLIENT_RELEASE_NOTES",
#         (
#             f"{package_name} wheel {version}\n\n"
#             "Includes:\n"
#             "- PWMCP client package\n"
#             "- WebSocket utilities\n"
#             "- Optional UI helpers\n"
#         ),
#     )
...
def main() -> None:
    ...
    api_base = os.getenv("GITHUB_API", "https://api.github.com")
    release_asset_name = wheel_path.name
    latest_asset_name = wheel_path.name
