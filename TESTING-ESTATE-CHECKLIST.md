...
| [`ciu/`](ciu/assay.toml) | `6b5d7fe3 / 2026-09-22` | ✅ | ✅ | ✅ | ✅ | Assay requires branches and a 100% floor | Assay lane in `tester-unified`, `dev-gates.slice` | PASS at `6b5d7fe3`, container `run-gate-vbpub-ciu-3223416-1790106689`: 65/65 killed, zero survivors/hangs/crashes/overruns | Declared complete R0-R3 lane with full pytest-cov line+branch command | Hypothesis property tests cover path, size, and argument grammars with deterministic gate settings; Schemathesis N/A for this CLI surface | Independent checklist review remains |
| [`cmru/`](cmru/assay.toml) | `6b5d7fe3 / 2026-09-22` | ✅ | ✅ | ✅ | ✅ | Assay requires branches and a 100% floor | Assay plus raw `run-gate.toml` command lanes in `tester-unified`, `dev-gates.slice` | PASS at `6b5d7fe3`, aggregate container `run-gate-vbpub-assay-3315120-1790109732`; 1885 passed/10 skipped, 72/72 mutation candidates killed, canary and enrollment PASS | Declared complete R0-R3 lane plus supplemental coverage, mutation, canary, and enrollment lanes | Hypothesis property tests cover naming/scope invariants with deterministic gate settings; no OpenAPI surface for Schemathesis | Independent checklist review remains |
| [`libraries/worktree/`](libraries/worktree/assay.toml) | `6b5d7fe3 / 2026-09-22` | ✅ | ✅ | ✅ | ✅ | Assay requires branches and a 100% floor | Dedicated Assay lane in `tester-unified`, `dev-gates.slice` | PASS at `6b5d7fe3`, container `run-gate-vbpub-worktree-3182024-1790105147`: 183/183 killed, zero survivors/hangs/crashes/overruns | Complete internal S1 R0-R3 lane with line+branch floor, serial mutation, and import-break canary | Hypothesis identity/path properties use deterministic gate settings; no API surface for Schemathesis | Independent checklist review remains |
