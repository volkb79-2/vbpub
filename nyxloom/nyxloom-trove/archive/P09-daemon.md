# P09 — nyxloomd: resident reconciler + HTTP/SSE surface
...
> noted · Read first: handoff/STANDING.md, src/nyxloom/daemon.py
...
- All storage writes via append_and_apply, actor Actor(TICK,'nyxloomd').
