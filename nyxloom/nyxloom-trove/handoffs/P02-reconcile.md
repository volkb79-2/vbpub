...
> src/nyxloom/reconcile.py (docstring = the normative semantics, items
> 1–8), src/nyxloom/types.py, docs/SPEC.md §5 §8 §9.

## Owned files
- `src/nyxloom/reconcile.py` (implement `plan_project` and
