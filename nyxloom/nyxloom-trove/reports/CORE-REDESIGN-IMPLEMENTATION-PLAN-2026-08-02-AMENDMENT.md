...
| CR-04 through CR-14, CR-16 | pending | Dependency order in section 7 remains authoritative. CR-04 (direct SQLite-only store) is next: it depends on CR-00 and CR-03, both now accepted. |
