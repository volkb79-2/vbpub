...
| CR-05 | next | Depends on CR-03 and CR-04, both accepted. Nothing blocks it. Operator-carved and frontier-implemented per the labour model; amendment section 3.3 adds the state-ownership acceptance. See `handoffs/CORE-REDESIGN-SESSION-HANDOFF-2026-08-03.md` for the working loop and the consequences of the accepted packages a new package must respect. |
