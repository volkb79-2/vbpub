...
```
cd /workspaces/vbpub/nyxloom && /workspaces/vbpub/.venv/bin/python -m pytest tests/test_properties.py tests/test_crash.py -q
```
...
- **Oracle 9 was not skipped.** At the time this handoff was picked up, `src/nyxloom/wrapper.py`
