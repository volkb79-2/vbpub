...
Implemented DECISIONS-INBOX.md parsing and integration module for nyxloom. All 5 core functions are fully functional with comprehensive test coverage.
...
- `src/nyxloom/decisions.py` — implementation (95 lines)
