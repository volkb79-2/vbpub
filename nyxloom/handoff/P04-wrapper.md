...
> src/nyxloom/wrapper.py (docstring = normative, steps 1–10),
> src/nyxloom/{storage,leases,types}.py.
...
from nyxloom.types import (Actor, ActorKind, Attempt, AttemptState,
