...
LEGACY_BUDGET: dict[str, int] = {
    ...
    # 35 -> 33 (CR-05a: the journal's notify containment and the gate-verify
    # probe's degradation) -> 31 (CR-05b: the handoff-frontmatter reader's
    ...
    # with the carver-session surface and CLASSIFIED it there; CR-05f took
    # the re-scope prompt's handoff read with the carve surface.
    "daemon.py": 29,
