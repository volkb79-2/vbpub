...
scripts/build-image.sh pterodactyl cgroup.7 # -> wings-local:1.13.1-cgroup.7
```
...
scripts/build-image.sh pterodactyl cgroup.8   # bump the suffix per deployable change
