...
| 12 | v2 action/inspection gating | Partial | Disabled hotkeys, admin preview/audit, inspect-files planning, P46 admin execution kernel (gated start/stop/restart with validation, audit, timeout, injected-runner test fixtures) | Remaining v2 actions are a non-claim; only the narrow P46 allowlist is executable |
