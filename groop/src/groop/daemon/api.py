...
Additive envelope over the P51 :class:`~groop.daemon.broker.FrameBroker`. Every
...
from groop import __version__ as GROOP_VERSION
...
from groop.registry import REGISTRY, MetricSpec
...
class DaemonApi:
    ...
    identity_name: str = "groop-daemon"
    ...
    def _op_entity(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        from groop.model import entity_frame_to_jsonable
...
def _safe_message(text: str) -> str:
    ...
    """
    from groop.daemon.component_health import sanitize_public_text, MAX_HEALTH_ERROR_BYTES
