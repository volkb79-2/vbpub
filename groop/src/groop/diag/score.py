...
from groop.config import GroopConfig, ThresholdBand
from groop.model import EntityFrame, MetricValue
...
def score_entity(entity_frame: EntityFrame, config: GroopConfig) -> ScoreBreakdown:
...
def pressure_breakdown(entity_frame: EntityFrame, config: GroopConfig) -> tuple[dict[str, object], ...]:
