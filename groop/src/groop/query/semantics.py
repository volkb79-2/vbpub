...
differential-equal to ``groop report`` on the same recording and window; this
...
from groop.report import _nearest_rank_percentile

from .errors import IncompatibleQueryError, InvalidQueryError

# Reuse report's rounding grain so figures diff byte-identically with `groop
