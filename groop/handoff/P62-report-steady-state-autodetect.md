...
Add optional automatic steady-state window detection to `groop report`: instead
...
- Touch only `groop/**`; write P62-LOG.md/P62-REPORT.md; commit, do not merge.
...
- Run focused (`groop/tests/test_report.py`) and full suite with `-W error`,
