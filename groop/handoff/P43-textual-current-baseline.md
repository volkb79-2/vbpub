...
Make normal Groop installations resolve the current supported Textual release
...
- Touch only `groop/**`
- Keep `groop/handoff/reports/P43-LOG.md` current
- Finish with `groop/handoff/reports/P43-REPORT.md` and focused commits
...
- In an isolated environment with no preinstalled Textual, install the local
  ...
  version. Require 8.2.8 or newer and run `groop --version`, direct replay UI
