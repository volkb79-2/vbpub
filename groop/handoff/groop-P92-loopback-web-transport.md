---
schema_version: 1
id: groop-P92-loopback-web-transport
project: groop
...
stack: none
depends_on: [groop-P91-persistent-capped-history]
scope:
  touch: ["groop/**"]
  forbid: []
oracles:
  ...
  - id: O2
    ...
    gate: groop-suite
  - id: O3
    observable: "a spoofed X-Groop-Principal header has no effect on authorization"
  ...
  - id: O8
    ...
    gate: groop-suite
  - id: O9
    observable: "the CIU-network-only PWMCP test fixture loads the token-protected page from the Groop-owned PWMCP instance and asserts health with no browser console errors"
