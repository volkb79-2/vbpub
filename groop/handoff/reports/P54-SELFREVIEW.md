...
### 2. Scope: every file inside `groop/**`; nothing skipped
...
groop/handoff/reports/P54-LOG.md
groop/handoff/reports/P54-REPORT.md
groop/src/groop/cli.py
groop/src/groop/report.py
groop/tests/test_report.py
```
