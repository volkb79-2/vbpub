...
correct and genuinely driven by groop's code (Oracles 1/2/5 hold, and the
...
```
pytest groop/tests/test_grouping.py groop/tests/test_grouping_ui.py -q -W error -p no:schemathesis
