...
- **Location**: `groop/handoff/reports/P55-LOG.md`
...
- **Location**: `groop/src/groop/collect/collector.py` line 66
...
- **Location**: `groop/handoff/reports/P55-REPORT.md`
...
- **Location**: `groop/tests/test_p55_filtering.py`
...
- **Location**: `groop/handoff/reports/P55-REPORT.md`
- **Issue**: The handoff protocol requires `groop --once --json` (or the package's own entry point) demonstrably runs. While the test suite exercises the code paths, a direct CLI invocation was not shown.
- **Fix**: Added a CLI smoke command and its output to the REPORT.
- **Flagged-by-pass-1**: yes

## Items verified clean

- All 11 files in the diff are under `groop/**` — scope is clean.
