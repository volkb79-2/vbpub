...
```bash
timeout 900 env PYTHONPATH=groop/src /tmp/p43-clean-venv/bin/python -m pytest \
...
```bash
python3 -m py_compile groop/src/groop/daemon/http_gateway.py \
  groop/src/groop/cli.py groop/tests/test_daemon_http_gateway.py
# clean
...
```text
groop/src/groop/daemon/http_gateway.py       hardened stdlib gateway
groop/src/groop/cli.py                       gateway serve command and explicit opt-in
groop/tests/test_daemon_http_gateway.py      real-stack adversarial coverage
groop/docs/DAEMON.md                         deployment and HTTP contract
groop/README.md                              P67 status
groop/handoff/reports/P67-LOG.md             resumability log
groop/handoff/reports/P67-REPORT.md          this report
```
