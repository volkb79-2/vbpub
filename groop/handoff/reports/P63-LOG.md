...
python3 -m py_compile groop/src/groop/daemon/client.py
python3 -m py_compile groop/src/groop/daemon/__init__.py
python3 -m py_compile groop/tests/test_daemon_client_p63.py
git diff --check
```
