...
# CLI smoke: groop --once --json --slice system.slice --metrics ram,psi_mem_some_avg10 exits 0
...
| `groop/docs/STATUS.md` | Added P60 to Implemented section |
| `groop/handoff/reports/P60-LOG.md` | Work log |
| `groop/handoff/reports/P60-REPORT.md` | This report |
