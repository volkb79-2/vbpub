...
errors at plugin-import time, unrelated to groop.

```
pytest groop/tests/test_actions.py groop/tests/test_p72_kill_update.py -q -W error
  -> 251 passed          (200 + 51, both files UNMODIFIED by the diff)
pytest groop/tests/test_p78_action_kernel.py -q -W error
  -> 72 passed           (65 original + 7 added at review)
timeout 900 pytest groop/tests -q
