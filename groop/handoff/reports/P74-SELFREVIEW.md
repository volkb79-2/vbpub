...
Mechanical re-check of the diff against the P74 handoff, per groop/README.md
...
- ✅ `timeout 1800 env PYTHONPATH=src python3 -m pytest tests -q -W error -p no:schemathesis`
  ...
  (P60 groop/src path, TUI snapshot) are documented as environment-specific.

- ✅ `PYTHONPATH=src python3 -m groop.cli --once --json` — runs on this GPU-less
...
**Scope:** `groop/**` (README.md workflow protocol). All touched paths:

| Path | In scope | Notes |
|---|---|---|
| `groop/src/groop/collect/host.py` | ✅ | Additive GPU functions + import re |
| `groop/src/groop/registry.py` | ✅ | 4 new MetricSpec entries |
| `groop/src/groop/ui/banner.py` | ✅ | `_gpu_line()` + wiring |
| `groop/tests/test_gpu.py` | ✅ | New test file |
| `groop/tests/fixtures/sysfs/drm/...` | ✅ | 15 fixture files |
| `groop/handoff/reports/P74-LOG.md` | ✅ | Per standing contract |
| `groop/handoff/reports/P74-REPORT.md` | ✅ | Per standing contract |
| `groop/handoff/reports/P74-SELFREVIEW.md` | ✅ | Per standing contract |
| `groop/docs/ARCHITECTURE.md` | ✅ | Dataflow + module map |
| `groop/docs/STATUS.md` | ✅ | Not-Implemented line |
| `groop/docs/ROADMAP.md` | ✅ | P74 `:done:` |
| `groop/README.md` | ✅ | P74 Queued→Done |
