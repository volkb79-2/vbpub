...
**Task:** `groop-P65-report-human-readable-render`
...
```
 groop/README.md            |  37 +++--
 groop/src/groop/cli.py     |  67 +++++++--
 groop/src/groop/render.py  | 340 +++++++++++++++++++++++++++++++++++++++++++++
 groop/tests/test_render.py | 331 +++++++++++++++++++++++++++++++++++++++++++
 groop/tests/test_report.py |  24 +++-
```
...
Declared gate (`groop[dev]` venv, `pytest groop/tests`) re-run by the reviewer:
