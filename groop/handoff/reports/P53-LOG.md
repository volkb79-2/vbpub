...
- Files: groop/src/groop/cli.py, groop/src/groop/record/live.py, groop/src/groop/record/writer.py, groop/tests/
...
- Action: Created groop/src/groop/record/headless.py with HeadlessRecordDriver
- Files: groop/src/groop/record/headless.py
...
- Files: groop/tests/test_headless_record.py
...
- Files: groop/src/groop/record/headless.py, groop/tests/test_headless_record.py, groop/src/groop/cli.py
...
- Files: groop/README.md, groop/CONTRACTS.md
...
- Decision: Interval override uses dataclasses.replace
  Reason: GroopConfig is frozen; assignment to .interval raises FrozenInstanceError
