...
Date: 2026-07-13. Branch: `feat/groop-p72-admin-action-kill-update` (implementation
...
### F6 — Docs inserted mid-section, splitting the `groop squeeze` runbook entry
...
The kill/update guidance was appended as indented paragraphs *inside* the `groop
