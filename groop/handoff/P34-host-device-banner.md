...
- Touch only `groop/**`
- Keep `groop/handoff/reports/P34-LOG.md` updated while working
- Finish with `groop/handoff/reports/P34-REPORT.md` and a focused commit
...
- Do not add Textual-specific code outside `src/groop/ui/`.
...
- `groop/docs/STATUS.md` partial/implemented banner notes as appropriate.
- `groop/docs/ARCHITECTURE.md` or `groop/docs/OPERATIONS.md` only if needed to
