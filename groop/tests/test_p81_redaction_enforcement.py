...
# groop[mcp] is an optional extra; without the SDK this whole module skips
...
from groop.daemon import (  # noqa: E402
    DaemonApi,
    FrameBroker,
    Sensitivity,
    serve_versioned_unix_socket,
)
from groop.daemon import redaction  # noqa: E402
from groop.daemon.client import DaemonClient  # noqa: E402
from groop.daemon.http_gateway import (  # noqa: E402
    IDENTITY_HEADER,
    GatewayAuthConfig,
    GatewayConfig,
...
from groop.daemon.redaction import PayloadShape, classify_metric, redaction_marker  # noqa: E402
from groop.mcp.server import McpServer  # noqa: E402
from groop.model import (  # noqa: E402
    Entity,
    EntityFrame,
    Finding,
    Frame,
...
def _mcp_entity_text(mcp: McpServer) -> str:
    return asyncio.run(_mcp_tool_text(mcp, "groop_entity", {"selector": ENTITY_KEY}))
...
def test_oracle1_findings_bypass_is_closed_on_both_frontends(tmp_path: Path) -> None:
    ...
    _assert_sentinel_absent("mcp groop_entity", mcp_text)
