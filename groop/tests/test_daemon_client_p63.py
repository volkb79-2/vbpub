...
from groop.daemon.component_health import ComponentHealthRegistry
...
def test_request_hello_returns_protocol_info(tmp_path: Path) -> None:
    ...
    try:
        ...
        assert hello.identity["name"] == "groop-daemon"
...
def test_import_does_not_trigger_heavy_imports() -> None:
    ...
    import groop.daemon.client as client_mod  # noqa: PLC0415  # fresh import check
