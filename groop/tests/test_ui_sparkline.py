...
from groop.ui.sparkline import render_sparkline, sparkline_from_history
from groop.ui.table import _format_cpu_trend, format_metric_value
...
def test_format_cpu_trend_sort_value() -> None:
    ...
    from groop.ui.table import metric_sort_value
