...
class TestP72SignalValidation:
    ...
    def test_valid_signals_pass(self) -> None:
        from groop.actions.kill_ops import validate_signal
...
class TestP72KillPlan:
    ...
    def test_docker_kill_argv(self) -> None:
        from groop.actions.kill_ops import build_kill_preview, DOCKER_EXECUTABLE
    ...
    def test_systemd_kill_argv(self) -> None:
        from groop.actions.kill_ops import build_kill_preview, SYSTEMCTL_EXECUTABLE
    ...
    def test_kill_preview_renders_signal(self) -> None:
        from groop.actions.kill_ops import build_kill_preview, render_kill_preview
    ...
    def test_kill_plan_to_jsonable(self) -> None:
        from groop.actions.kill_ops import build_kill_preview, kill_plan_to_jsonable
...
class TestP72KillForceGate:
    ...
    def test_kill_without_force_refused(self) -> None:
        from groop.actions.kill_ops import build_kill_preview
...
class TestP72UpdateMemoryValidation:
    ...
    def test_valid_memory_values(self) -> None:
        from groop.actions.update_ops import validate_memory
...
class TestP72UpdateCPUSValidation:
    ...
    def test_valid_cpus(self) -> None:
        from groop.actions.update_ops import validate_cpus
...
class TestP72KillPlanPreviewIntegration:
    ...
    def test_kill_preview_via_build_admin_preview(self) -> None:
        from groop.actions.preview import build_admin_preview
        from groop.actions.kill_ops import KillPlan
        from groop.actions.catalog import DOCKER_EXECUTABLE
    ...
    def test_update_preview_via_build_admin_preview(self) -> None:
        from groop.actions.preview import build_admin_preview
        from groop.actions.update_ops import UpdatePlan
        from groop.actions.catalog import DOCKER_EXECUTABLE
    ...
    def test_kill_preview_no_admin_returns_disabled(self) -> None:
        from groop.actions.preview import build_admin_preview, DisabledPlan
...
class TestP72AuditFailClosed:
    ...
    def test_kill_audit_failure_blocks_execution(self, tmp_path: Path, monkeypatch) -> None:
        from groop.actions.execute import execute_kill, ExecuteResult
        import groop.actions.execute as execute_mod
