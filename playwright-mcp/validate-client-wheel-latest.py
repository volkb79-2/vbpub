#!/usr/bin/env python3
"""Validate Playwright MCP client latest wheel asset from GitHub Releases."""
...
def main() -> None:
    ...
    latest_tag = os.getenv("PWMCP_LATEST_TAG", "playwright-mcp-client-wheel-latest")
    ...
    print("[INFO] playwright-mcp-client latest release asset found")
