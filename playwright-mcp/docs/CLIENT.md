...
This package is published as the `playwright-mcp-client` wheel and is tailored to the Playwright MCP WebSocket server in this repository.
...
```python
from playwright_mcp_client import RetryPolicy, async_retry
