...
Versioned package manifest for `modern-debian-tools-python-debug-php85-vsc-devcontainer`.

## Release

- Build date: `20260630-2`
- Target: `trixie-py314-php85-vsc`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260630-2`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-php85-vsc-devcontainer:trixie-py3.14-20260630-2
```
...
- Family overview: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-php85-vsc-devcontainer/README.md
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-php85-vsc-devcontainer/trixie-py3.14-20260630-2.md
...
- codex 0.142.4 (tar.gz): sha256 `79d049427514a9298e77be92ad9bbb74a346b50fa659851f807da7363da11cbd`; source `https://github.com/openai/codex/releases/download/rust-v0.142.4/codex-package-x86_64-unknown-linux-musl.tar.gz`
- codex-sha256sums 0.142.4 (checksum-file): sha256 `cafd26763af753f20e4cd972a9460ca0c49745351e2806cfe06c7576fecfba92`; source `https://github.com/openai/codex/releases/download/rust-v0.142.4/codex-package_SHA256SUMS`
- claude 2.1.197 (binary): sha256 `f54e69cbc89b2da61a415700af7ff52a147e862517d4f1b0eecf768448cf7f83`; source `https://downloads.claude.ai/claude-code-releases/2.1.197/linux-x64/claude`
- claude-manifest 2.1.197 (manifest): sha256 `f16915abaf278744337a23d8daf7cc4846f10672301cafb781fdc15a0137373e`; source `https://downloads.claude.ai/claude-code-releases/2.1.197/manifest.json`
- antigravity 1.0.14 (tar.gz): sha256 `7170d598193ee0addcaba7d8c3a2c2e307ae8622dacf749831128bd1ad3ca458`; source `https://storage.googleapis.com/antigravity-public/antigravity-cli/1.0.14-6049473256882176/linux-x64/cli_linux_x64.tar.gz`
- antigravity-manifest 1.0.14 (manifest): sha256 `786364eda6c6f3ef60dd9e7d2138a8a9d1117575c1d06d3a27768f539ec5e906`; source `https://antigravity-cli-auto-updater-974169037036.us-central1.run.app/manifests/linux_amd64.json`
...
- nvim 0.12.3 (tar.gz): sha256 `c441b547142860bf01bcce39e36cbed185c41112813e15443b16e5237750724d`; source `https://github.com/neovim/neovim/releases/download/v0.12.3/nvim-linux-x86_64.tar.gz`
...
- lazydocker 0.25.2 (tar.gz): sha256 `0d9dbfc26068b218e7ed84b104748cadc6e3cf733c0afd35465306fb39b9523c`; source `https://github.com/jesseduffield/lazydocker/releases/download/v0.25.2/lazydocker_0.25.2_Linux_x86_64.tar.gz`
- lazydocker-checksums 0.25.2 (checksum-file): sha256 `2658d90cbb929662b06210c45eefbdfd32517c906dafd543527b9c06220aa4a4`; source `https://github.com/jesseduffield/lazydocker/releases/download/v0.25.2/checksums.txt`
- dive 0.13.1 (deb): sha256 `0c20d18f0cc87e6e982a3289712ac3aa9fc364ba973109d1da3a473232640571`; source `https://github.com/wagoodman/dive/releases/download/v0.13.1/dive_0.13.1_linux_amd64.deb`
- dive-checksums 0.13.1 (checksum-file): sha256 `ca1c0b36de3d9de2c6a8ea0f58ca506d2bfe9afeb78859258187322e9519b3ca`; source `https://github.com/wagoodman/dive/releases/download/v0.13.1/dive_0.13.1_checksums.txt`
- syft 1.46.0 (tar.gz): sha256 `d654f678b709eb53c393d38519d5ed7d2e57205529404018614cfefa0fb2b5ca`; source `https://github.com/anchore/syft/releases/download/v1.46.0/syft_1.46.0_linux_amd64.tar.gz`
- syft-checksums 1.46.0 (checksum-file): sha256 `2fefc202b2eccab83888cc91f5a364a75df0dd777afbbae5b5e23ebd93d81ac6`; source `https://github.com/anchore/syft/releases/download/v1.46.0/syft_1.46.0_checksums.txt`
- dtop 0.7.7 (tar.gz): sha256 `945b940632e926ea55d585dbe02ef6368ec698118ebd535c93a09c4f9b7833fc`; source `https://github.com/amir20/dtop/releases/download/v0.7.7/dtop-x86_64-unknown-linux-gnu.tar.gz`
- dtop-sha256sums 0.7.7 (checksum-file): sha256 `4e2e03c61f656e57edbcf99da7f374fd002d5c8b5eb55f25bb465ecfa5c64d91`; source `https://github.com/amir20/dtop/releases/download/v0.7.7/sha256.sum`
- glances 4.5.5 (pypi-network): sha256 `7411c0fc02881fa970a5c1b0af5953ffe211fe553ea2eab012d211e76c5bbc46`; source `https://pypi.org/pypi/glances/4.5.5/json`
- hadolint 2.14.0 (binary): sha256 `6bf226944684f56c84dd014e8b979d27425c0148f61b3bd99bcc6f39e9dc5a47`; source `https://github.com/hadolint/hadolint/releases/download/v2.14.0/hadolint-Linux-x86_64`
- hadolint-sha256 2.14.0 (checksum-file): sha256 `cbd28eb1be0ea35f28a26764b614e6f720eaf7789666a5b4e976718e1ec3655f`; source `https://github.com/hadolint/hadolint/releases/download/v2.14.0/hadolint-Linux-x86_64.sha256`
- grype 0.115.0 (tar.gz): sha256 `3fad92940650e514c0aa2dad83526942a055e210cec09a8a59d9c024adc2b90e`; source `https://github.com/anchore/grype/releases/download/v0.115.0/grype_0.115.0_linux_amd64.tar.gz`
...
- awscli 2.35.13 (zip): sha256 `9d8358b854dfac0decde81a0a21471abb5fd52d7366533bf25affcbbc2d5ad90`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
