...
- Build date: `20260630-3`
- Target: `trixie-py314-php85-vsc`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260630-3`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-php85-vsc-devcontainer:trixie-py3.14-20260630-3
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-php85-vsc-devcontainer/trixie-py3.14-20260630-3.md
