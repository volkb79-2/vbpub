...
- Debian: `bookworm`
- Python: `3.13`
- Immutable image tag: `bookworm-py3.13-20260511`
- Floating image tag: `bookworm-py3.13-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.13-20260511
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.13-20260511.md
