...
- Debian: `trixie`
- Python: `3.11`
- Immutable image tag: `trixie-py3.11-20260616-5`
- Floating image tag: `trixie-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:trixie-py3.11-20260616-5
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/trixie-py3.11-20260616-5.md
- Source tree: https://github.com/volkb79-2/vbpub/tree/main/modern-debian-tools-python-debug

## In-Image File

- Devcontainer manifest: `/home/vscode/devcontainer-manifest-trixie-py3.11-20260616-5.md`
