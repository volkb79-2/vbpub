...
- Build date: `20260604-4`
- Target: `bookworm-py313`
- Debian: `bookworm`
- Python: `3.13`
- Immutable image tag: `bookworm-py3.13-20260604-4`
- Floating image tag: `bookworm-py3.13-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.13-20260604-4
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.13-20260604-4.md
