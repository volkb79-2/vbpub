...
- Build date: `20260616-4`
- Target: `bookworm-py311`
- Debian: `bookworm`
- Python: `3.11`
- Immutable image tag: `bookworm-py3.11-20260616-4`
- Floating image tag: `bookworm-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.11-20260616-4
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.11-20260616-4.md
- Source tree: https://github.com/volkb79-2/vbpub/tree/main/modern-debian-tools-python-debug

## In-Image File

- Devcontainer manifest: `/home/vscode/devcontainer-manifest-bookworm-py3.11-20260616-4.md`
