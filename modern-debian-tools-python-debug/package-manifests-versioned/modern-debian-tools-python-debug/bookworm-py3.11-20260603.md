...
- Debian: `bookworm`
- Python: `3.11`
- Immutable image tag: `bookworm-py3.11-20260603`
- Floating image tag: `bookworm-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.11-20260603
```
...
- awscli 2.34.60 (zip): sha256 `a34f1896e9e5f673d9e67f2033ac629a7e9b0fe9d4eb87656edb21c11cacc8ed`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.11-20260603.md
