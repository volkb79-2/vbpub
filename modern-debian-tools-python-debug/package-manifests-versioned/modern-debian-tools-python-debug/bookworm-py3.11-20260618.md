...
- Debian: `bookworm`
- Python: `3.11`
- Immutable image tag: `bookworm-py3.11-20260618`
- Floating image tag: `bookworm-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.11-20260618
```
...
- awscli 2.35.7 (zip): sha256 `300cd0b8a8dd64f080202e02ef1745bf327b8a2546054a2d036869c0f27f4199`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.11-20260618.md
- Source tree: https://github.com/volkb79-2/vbpub/tree/main/modern-debian-tools-python-debug

## In-Image File

- Devcontainer manifest: `/home/vscode/devcontainer-manifest-bookworm-py3.11-20260618.md`
