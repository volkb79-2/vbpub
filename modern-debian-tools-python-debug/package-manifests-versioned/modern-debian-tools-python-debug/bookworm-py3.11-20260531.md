...
- Debian: `bookworm`
- Python: `3.11`
- Immutable image tag: `bookworm-py3.11-20260531`
- Floating image tag: `bookworm-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.11-20260531
```
...
- awscli 2.34.57 (zip): sha256 `7a83eadaf8bf974e9e5b31d396c036349014e7237caaff32c8f79007448307fb`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.11-20260531.md
