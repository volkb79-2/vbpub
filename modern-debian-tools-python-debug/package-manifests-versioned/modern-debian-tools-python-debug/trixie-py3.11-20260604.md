...
```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:trixie-py3.11-20260604
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/trixie-py3.11-20260604.md
