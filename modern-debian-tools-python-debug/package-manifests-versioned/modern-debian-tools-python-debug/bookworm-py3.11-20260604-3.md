...
- Build date: `20260604-3`
- Target: `bookworm-py311`
- Debian: `bookworm`
- Python: `3.11`
- Immutable image tag: `bookworm-py3.11-20260604-3`
- Floating image tag: `bookworm-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug:bookworm-py3.11-20260604-3
```
...
- codex 0.137.0 (tar.gz): sha256 `b364488097efd12da3b5ffb1b0099cabd8b377b1f97043158f7f771b1456953f`; source `https://github.com/openai/codex/releases/download/rust-v0.137.0/codex-package-x86_64-unknown-linux-musl.tar.gz`
- codex-sha256sums 0.137.0 (checksum-file): sha256 `dcbb95b963f6a715d5a94ef35deee69a541f811d6e6e02cf50bab3bc037932eb`; source `https://github.com/openai/codex/releases/download/rust-v0.137.0/codex-package_SHA256SUMS`
- claude 2.1.162 (binary): sha256 `947a49b0de8688f6a74a6e753c24771ff3ddd17b2a6dae85f36304ec514e61d1`; source `https://downloads.claude.ai/claude-code-releases/2.1.162/linux-x64/claude`
- claude-manifest 2.1.162 (manifest): sha256 `3293d692edcc9d277db209e13c3fbc130a6075c50590aa09164a96643c20a328`; source `https://downloads.claude.ai/claude-code-releases/2.1.162/manifest.json`
- antigravity 1.0.5 (tar.gz): sha256 `2101c31fbc33189999f44c08abd2df4937d002e78fce5a92e71f0d0a248fdccc`; source `https://storage.googleapis.com/antigravity-public/antigravity-cli/1.0.5-5009297080451072/linux-x64/cli_linux_x64.tar.gz`
- antigravity-manifest 1.0.5 (manifest): sha256 `6bbd3df6c46d4a31ab9902dff03973753401fa5670a09c839b137088163316e3`; source `https://antigravity-cli-auto-updater-974169037036.us-central1.run.app/manifests/linux_amd64.json`
...
- awscli 2.34.61 (zip): sha256 `f83279604948cb216fa6dfc640c3f01b8f04b29a9d4b1c8252bf2588b236ed2c`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug/bookworm-py3.11-20260604-3.md
