...
Debian `trixie`-based container image bundling Python 3.14, PHP 8.5, and a curated suite of modern developer, debugging, and operations tools. Designed for interactive development, CI/CD pipelines, and remote debugging sessions where a rich CLI environment is needed out of the box.
