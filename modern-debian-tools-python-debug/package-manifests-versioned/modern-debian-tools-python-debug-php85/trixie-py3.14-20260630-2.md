...
Versioned package manifest for `modern-debian-tools-python-debug-php85`.
...
```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-php85:trixie-py3.14-20260630-2
```
...
- Family overview: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-php85/README.md
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-php85/trixie-py3.14-20260630-2.md
