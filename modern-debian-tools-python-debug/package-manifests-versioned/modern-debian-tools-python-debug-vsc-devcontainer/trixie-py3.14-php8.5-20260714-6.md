# Devcontainer Manifest — trixie-py3.14-20260714-6

## Release

- Build date: `20260714-6`
- Target: `unknown`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260714-6`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-20260714-6
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-20260714-6.md
