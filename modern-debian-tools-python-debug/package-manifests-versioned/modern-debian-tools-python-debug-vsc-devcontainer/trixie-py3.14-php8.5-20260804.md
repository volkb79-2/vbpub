# Devcontainer Manifest — trixie-py3.14-php8.5-20260804

## Release

- Build date: `20260804`
- Built at (UTC): `2026-08-04T03:19:29Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260804`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260804
```
...
- Debian: trixie
- Python: 3.14
- Image version: 20260804
- Image tag: trixie-py3.14-php8.5-20260804
- Devcontainers release: v0.4.30
- Devcontainers image version: 3.1.6

## Purpose

Modern Debian Tools + Python Debug + PHP 8.5 VS Code devcontainer image. Adds PHP 8.5 CLI/FPM, composer, Xdebug, and the common PHP extensions needed for web debugging. Docs: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260804.md
...
- PHP: `PHP 8.5.9 (cli) (built: Jul 30 2026 14:58:20) (NTS)`
...
| `antigravity` | `1.1.10` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:9e94cfffa869ee2bf9ab32e0…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.1.10-6423386432339968/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.221 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:60db8e88d42c24b5199c92cf…`](https://downloads.claude.ai/claude-code-releases/2.1.221/linux-x64/claude) |
| `codex` | `codex-cli 0.146.0` | latest | https://github.com/openai/codex |  |
| `copilot` | `GitHub Copilot CLI 1.0.78.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.7.1-2 (0790d9f)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.12` | latest | https://github.com/anomalyco/opencode |  |
| `reasonix` | `reasonix v1.19.4` | latest | https://github.com/reasonix/reasonix |  |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `crane` | `0.21.8` | latest | https://github.com/google/go-containerregistry | [`sha256:59b59f68ee37aba51f5523d6…`](https://github.com/google/go-containerregistry/releases/download/v0.21.8/go-containerregistry_Linux_x86_64.tar.gz) |
...
| `dtop` | `dtop 0.7.11` | latest | https://github.com/amir20/dtop | [`sha256:424fd023eff576198f42ed55…`](https://github.com/amir20/dtop/releases/download/v0.7.11/dtop-x86_64-unknown-linux-gnu.tar.gz) |
...
| `lnav` | `0.14.0` | latest | https://github.com/tstack/lnav | [`sha256:9d146d1da2af005a77920aff…`](https://github.com/tstack/lnav/releases/download/v0.14.0/lnav-0.14.0-linux-musl-x86_64.zip) |
| `regctl` | `0.11.5` | latest | https://github.com/regclient/regclient | [`sha256:c93aa7638749f5aaac1a8e01…`](https://github.com/regclient/regclient/releases/download/v0.11.5/regctl-linux-amd64) |
| `syft` | `syft 1.50.0` | latest | https://github.com/anchore/syft | [`sha256:bf7b29ff57f06da30918266a…`](https://github.com/anchore/syft/releases/download/v1.50.0/syft_1.50.0_linux_amd64.tar.gz) |
...
| `grype` | `Application:         grype` | latest | https://github.com/anchore/grype | [`sha256:0122df7b655981abe547ad3d…`](https://github.com/anchore/grype/releases/download/v0.116.1/grype_0.116.1_linux_amd64.tar.gz) |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.36.9 Python/3.14.6 Linux/7.1.3+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | [`sha256:9b92ccb50dfc55479ac14c4b…`](https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip) |
| `b2` | `b2 command line tool, version 4.7.1 (b2sdk version 2.12.0)` | latest | https://github.com/Backblaze/B2_Command_Line_Tool | [`sha256:0f4720858f137cbbdb434f13…`](https://github.com/Backblaze/B2_Command_Line_Tool/releases/download/v4.7.1/b2-linux) |
...
| `consul` | `Consul v2.0.2` | latest | https://github.com/hashicorp/consul | [`sha256:96e56c9d06b4a15bfa316afa…`](https://releases.hashicorp.com/consul/2.0.2/consul_2.0.2_linux_amd64.zip) |
...
| `fd` | `fd 10.4.2` | latest | https://github.com/sharkdp/fd | [`sha256:def59805cd14b5651b689908…`](https://github.com/sharkdp/fd/releases/download/v10.4.2/fd-v10.4.2-x86_64-unknown-linux-gnu.tar.gz) |
| `fzf` | `0.74.2 (3337be9d)` | latest | https://github.com/junegunn/fzf | [`sha256:b3648f48675612b69ee35371…`](https://github.com/junegunn/fzf/releases/download/v0.74.2/fzf-0.74.2-linux_amd64.tar.gz) |
| `gh` | `gh version 2.97.0 (2026-07-31)` | latest | https://github.com/cli/cli | [`sha256:a2c9b8497e1f85b1ad0dfcb7…`](https://github.com/cli/cli/releases/download/v2.97.0/gh_2.97.0_linux_amd64.tar.gz) |
| `grpcurl` | `grpcurl v1.9.3` | latest | https://github.com/fullstorydev/grpcurl | [`sha256:a926b62a85787ccf73ef8736…`](https://github.com/fullstorydev/grpcurl/releases/download/v1.9.3/grpcurl_1.9.3_linux_x86_64.tar.gz) |
| `htop` | `htop 3.5.2` | latest | https://github.com/htop-dev/htop | [`sha256:a66a62bbd1eba59889c68f86…`](https://github.com/htop-dev/htop/archive/refs/tags/3.5.2.tar.gz) |
...
| `nvim` | `0.12.4` | latest | https://github.com/neovim/neovim | [`sha256:012bf3fcac5ade43914df3f1…`](https://github.com/neovim/neovim/releases/download/v0.12.4/nvim-linux-x86_64.tar.gz) |
| `php` | `PHP 8.5.9 (cli) (built: Jul 30 2026 14:58:20) (NTS)` | latest |  |  |
...
| `vault` | `Vault v2.0.3 (7193f9a48ff6093ca61b3b627a8671e770428ba6), built 2026-06-17T12:39:45Z` | latest | https://github.com/hashicorp/vault | [`sha256:1e0ffb7a82491219c7242da6…`](https://releases.hashicorp.com/vault/2.0.3/vault_2.0.3_linux_amd64.zip) |
| `yq` | `yq (https://github.com/mikefarah/yq/) version v4.53.3` | latest | https://github.com/mikefarah/yq | [`sha256:fa52a4e758c63d38299163fb…`](https://github.com/mikefarah/yq/releases/download/v4.53.3/yq_linux_amd64) |
...
- php8.5-cli: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-curl: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-fpm: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-gd: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-intl: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-mbstring: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-xdebug: `3.5.3-1+0~20260620.69+debian13~1.gbp8ad7a9`
- php8.5-xml: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- php8.5-zip: `8.5.9-1+0~20260730.22+debian13~1.gbp617955`
- postgresql-client: `18+293.pgdg13+1`
- psmisc: `23.7-2`
- python3-venv: `3.13.5-1`
- redis-tools: `6:8.10.0-1rl2~trixie1`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260804.md
