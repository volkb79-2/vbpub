...
- Build date: `20260624-3`
- Target: `trixie-py314-vsc`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260624-3`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-20260624-3
```
...
- cmru `1.1.1` — sha256: `fd7ca0d1e741d22764310de99fc3c2955d16d82b1f37d5190b945688efbfd95e`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-20260624-3.md
...
- claude 2.1.187 (binary): sha256 `bb02fcb33626f8c599d10d8bee38585d4cf8d4225c3b497869dee7454e7bf361`; source `https://downloads.claude.ai/claude-code-releases/2.1.187/linux-x64/claude`
- claude-manifest 2.1.187 (manifest): sha256 `5e5ef889ed16aac7b5242b42f769a910880315a9e86890edc1852d16dccfd014`; source `https://downloads.claude.ai/claude-code-releases/2.1.187/manifest.json`
