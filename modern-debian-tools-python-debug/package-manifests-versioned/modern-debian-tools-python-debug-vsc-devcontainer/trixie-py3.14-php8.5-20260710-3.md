# Devcontainer Manifest — trixie-py3.14-20260710-3

## Release

- Build date: `20260710-3`
- Target: `unknown`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260710-3`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-20260710-3
```
...
| `reasonix` | `reasonix v1.17.10` | latest | https://github.com/reasonix/reasonix |  |
...
| Tool | Version | Policy | Project Home | Package digest |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.35.21 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | `sha256:1fe665267a6149dfb8551cec…` |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-20260710-3.md
