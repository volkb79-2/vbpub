# Devcontainer Manifest — trixie-py3.14-php8.5-20260721-2

## Release

- Build date: `20260721-2`
- Built at (UTC): `2026-07-21T07:25:37Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260721-2`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260721-2
```
...
| `antigravity` | `1.1.5` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:1d586501b8a13d146e8aa3c7…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.1.5-5958982624477184/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.216 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:74deca45220b8080ec75ab09…`](https://downloads.claude.ai/claude-code-releases/2.1.216/linux-x64/claude) |
| `codex` | `codex-cli 0.144.6` | latest | https://github.com/openai/codex |  |
| `copilot` | `GitHub Copilot CLI 1.0.73.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.7.1-2 (0790d9f)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.4` | latest | https://github.com/anomalyco/opencode |  |
| `reasonix` | `reasonix v1.17.17` | latest | https://github.com/reasonix/reasonix |  |
...
| `dtop` | `dtop 0.7.9` | latest | https://github.com/amir20/dtop | [`sha256:d82a2fc664733561d6fe4ec9…`](https://github.com/amir20/dtop/releases/download/v0.7.9/dtop-x86_64-unknown-linux-gnu.tar.gz) |
...
| `syft` | `syft 1.48.0` | latest | https://github.com/anchore/syft | [`sha256:6cef9a7f37220d9067eaf9cf…`](https://github.com/anchore/syft/releases/download/v1.48.0/syft_1.48.0_linux_amd64.tar.gz) |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.36.4 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | [`sha256:86c1820b04c6a95350d6e910…`](https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260721-2.md
