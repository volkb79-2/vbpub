# Devcontainer Manifest — trixie-py3.14-php8.5-20260920

## Release

- Build date: `20260920`
- Built at (UTC): `2026-09-20T00:44:40Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260920`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260920
```
...
| `antigravity` | `1.2.7` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:e410dd56d8c213ef12643d3f…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.2.7-6731160148115456/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.278 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:5c4735937844e84f8a93306e…`](https://downloads.claude.ai/claude-code-releases/2.1.278/linux-x64/claude) |
...
| `pi` | `0.86.0` | latest | https://github.com/earendil-works/pi |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260920.md
