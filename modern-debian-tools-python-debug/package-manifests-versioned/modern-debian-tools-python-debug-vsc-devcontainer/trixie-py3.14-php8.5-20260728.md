# Devcontainer Manifest — trixie-py3.14-php8.5-20260728

## Release

- Build date: `20260728`
- Built at (UTC): `2026-07-28T13:03:36Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260728`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260728
```
...
| `opencode` | `1.18.8` | latest | https://github.com/anomalyco/opencode |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260728.md
