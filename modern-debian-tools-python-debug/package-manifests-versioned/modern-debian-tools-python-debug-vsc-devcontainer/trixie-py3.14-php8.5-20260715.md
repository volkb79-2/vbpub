# Devcontainer Manifest — trixie-py3.14-php8.5-20260715
...
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260715`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260715
```
...
| `regctl` | `VCSTag:     v0.11.5` | latest | https://github.com/regclient/regclient | [`sha256:c93aa7638749f5aaac1a8e01…`](https://github.com/regclient/regclient/releases/download/v0.11.5/regctl-linux-amd64) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260715.md
