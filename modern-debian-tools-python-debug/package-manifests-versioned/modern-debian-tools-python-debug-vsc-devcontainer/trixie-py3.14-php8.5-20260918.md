# Devcontainer Manifest — trixie-py3.14-php8.5-20260918
...
```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260918
```
...
| `copilot` | `Package extraction took 5523ms` | latest | https://github.com/github/copilot-cli |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260918.md
