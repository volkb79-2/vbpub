# Devcontainer Manifest — trixie-py3.14-php8.5-20260715-3

## Release

- Build date: `20260715-3`
- Built at (UTC): `2026-07-15T03:31:11Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260715-3`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260715-3
```
...
| `antigravity` | `1.1.2` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:0754010347926daf00c96734…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.1.2-5174998495789056/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.210 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:e7d2ceb53ed4c2ced1fe7fc1…`](https://downloads.claude.ai/claude-code-releases/2.1.210/linux-x64/claude) |
...
| `opencode` | `1.18.1` | latest | https://github.com/anomalyco/opencode |  |
...
| `syft` | `syft 1.46.0` | latest | https://github.com/anchore/syft | [`sha256:d654f678b709eb53c393d385…`](https://github.com/anchore/syft/releases/download/v1.46.0/syft_1.46.0_linux_amd64.tar.gz) |
...
| `grype` | `Application:         grype` | latest | https://github.com/anchore/grype | [`sha256:3fad92940650e514c0aa2dad…`](https://github.com/anchore/grype/releases/download/v0.115.0/grype_0.115.0_linux_amd64.tar.gz) |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.35.23 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | [`sha256:db818de6dd8096d19ac27534…`](https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip) |
...
| `fzf` | `0.74.0 (6765f464)` | latest | https://github.com/junegunn/fzf | [`sha256:cf919f05b7581b4c744d764e…`](https://github.com/junegunn/fzf/releases/download/v0.74.0/fzf-0.74.0-linux_amd64.tar.gz) |
...
| `htop` | `htop 3.5.1` | latest | https://github.com/htop-dev/htop | [`sha256:dfc4a09845e9bc86f466a722…`](https://github.com/htop-dev/htop/archive/refs/tags/3.5.1.tar.gz) |
...
| `ripgrep` | `ripgrep 15.1.0 (rev af60c2de9d)` | latest | https://github.com/BurntSushi/ripgrep | [`sha256:1c9297be4a084eea7ecaedf9…`](https://github.com/BurntSushi/ripgrep/releases/download/15.1.0/ripgrep-15.1.0-x86_64-unknown-linux-musl.tar.gz) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260715-3.md
