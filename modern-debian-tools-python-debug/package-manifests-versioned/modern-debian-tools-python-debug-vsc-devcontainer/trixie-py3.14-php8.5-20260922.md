# Devcontainer Manifest — trixie-py3.14-php8.5-20260922

## Release

- Build date: `20260922`
- Built at (UTC): `2026-09-22T17:35:57Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260922`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260922
```
...
| `antigravity` | `1.2.8` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:244752206d1f65c01aff4896…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.2.8-4907747922280448/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.280 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:1e08503dbdf3c2cb0d706d32…`](https://downloads.claude.ai/claude-code-releases/2.1.280/linux-x64/claude) |
| `claudelink` | `1.6.1` | latest | https://github.com/RBJGlobal/claudelink |  |
| `codex` | `codex-cli 0.155.1` | latest | https://github.com/openai/codex |  |
| `copilot` | `GitHub Copilot CLI 1.0.87.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.9.5 (ec9c1a1)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.32` | latest | https://github.com/anomalyco/opencode |  |
| `pi` | `0.87.0` | latest | https://github.com/earendil-works/pi |  |
| `reasonix` | `reasonix v1.38.11` | latest | https://github.com/reasonix/reasonix |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260922.md
