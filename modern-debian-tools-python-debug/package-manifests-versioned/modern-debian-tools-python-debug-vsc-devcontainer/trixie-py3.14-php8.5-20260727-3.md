# Devcontainer Manifest — trixie-py3.14-php8.5-20260727-3

## Release

- Build date: `20260727-3`
- Built at (UTC): `2026-07-27T21:23:07Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260727-3`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260727-3
```
...
| `antigravity` | `1.1.7` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:946cd06258d0ede72d031155…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.1.7-5951805767680000/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.220 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:674f61f20ff306f3100cf920…`](https://downloads.claude.ai/claude-code-releases/2.1.220/linux-x64/claude) |
| `codex` | `codex-cli 0.145.0` | latest | https://github.com/openai/codex |  |
| `copilot` | `GitHub Copilot CLI 1.0.75.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.7.1-2 (0790d9f)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.7` | latest | https://github.com/anomalyco/opencode |  |
| `reasonix` | `reasonix v1.17.21` | latest | https://github.com/reasonix/reasonix |  |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `crane` | `0.21.7` | latest | https://github.com/google/go-containerregistry | [`sha256:1a57bc98207fa1c0d04bf760…`](https://github.com/google/go-containerregistry/releases/download/v0.21.7/go-containerregistry_Linux_x86_64.tar.gz) |
...
| `glances` | `Glances version:	4.5.5` | latest | https://github.com/nicolargo/glances | [`sha256:7411c0fc02881fa970a5c1b0…`](https://pypi.org/pypi/glances/4.5.5/json) |
...
| `syft` | `syft 1.49.0` | latest | https://github.com/anchore/syft | [`sha256:7aa2f03ee92739cf643279ba…`](https://github.com/anchore/syft/releases/download/v1.49.0/syft_1.49.0_linux_amd64.tar.gz) |
...
| `grype` | `Application:         grype` | latest | https://github.com/anchore/grype | [`sha256:40aff724297312f91ea390d0…`](https://github.com/anchore/grype/releases/download/v0.116.0/grype_0.116.0_linux_amd64.tar.gz) |
| `hadolint` | `Haskell Dockerfile Linter 2.14.0` | latest | https://github.com/hadolint/hadolint | [`sha256:6bf226944684f56c84dd014e…`](https://github.com/hadolint/hadolint/releases/download/v2.14.0/hadolint-Linux-x86_64) |
...
| `fzf` | `0.74.1 (eae8d9d2)` | latest | https://github.com/junegunn/fzf | [`sha256:df53438be5f51e151bb4044d…`](https://github.com/junegunn/fzf/releases/download/v0.74.1/fzf-0.74.1-linux_amd64.tar.gz) |
| `gh` | `gh version 2.96.0 (2026-07-02)` | latest | https://github.com/cli/cli | [`sha256:83d5c2ccad5498f58bf6368a…`](https://github.com/cli/cli/releases/download/v2.96.0/gh_2.96.0_linux_amd64.tar.gz) |
...
- redis-tools: `6:8.8.1-1rl1~trixie1`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260727-3.md
