# Devcontainer Manifest — trixie-py3.14-php8.5-20260727

## Release

- Build date: `20260727`
- Built at (UTC): `2026-07-27T03:15:48Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260727`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260727
```
...
| `opencode` | `1.18.6` | latest | https://github.com/anomalyco/opencode |  |
...
| `dtop` | `dtop 0.7.10` | latest | https://github.com/amir20/dtop | [`sha256:014b06a34dafa96eac06503f…`](https://github.com/amir20/dtop/releases/download/v0.7.10/dtop-x86_64-unknown-linux-gnu.tar.gz) |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.36.8 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | [`sha256:829a2bbad5b4821a8d006a13…`](https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260727.md
