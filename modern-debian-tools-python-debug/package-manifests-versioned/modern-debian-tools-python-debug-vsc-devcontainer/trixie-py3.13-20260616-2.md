...
- Debian: `trixie`
- Python: `3.13`
- Immutable image tag: `trixie-py3.13-20260616-2`
- Floating image tag: `trixie-py3.13-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.13-20260616-2
```
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.13-20260616-2.md
