# Devcontainer Manifest — trixie-py3.14-php8.5-20260913
...
```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260913
```
...
| `antigravity` | `1.2.2` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:2cfa5c9a4a1edd96db6d4058…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.2.2-6061403484848128/linux-x64/cli_linux_x64.tar.gz) |
| `claude` | `2.1.270 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:3a624a5a7cd79bbad4d32bd7…`](https://downloads.claude.ai/claude-code-releases/2.1.270/linux-x64/claude) |
...
| `copilot` | `GitHub Copilot CLI 1.0.83.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.9.4 (3a9d69d)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.30` | latest | https://github.com/anomalyco/opencode |  |
| `pi` | `0.85.1` | latest | https://github.com/earendil-works/pi |  |
| `reasonix` | `reasonix v1.38.7` | latest | https://github.com/reasonix/reasonix |  |
...
| `syft` | `syft 1.51.1` | latest | https://github.com/anchore/syft | [`sha256:8fcb33017a0dc1058298c923…`](https://github.com/anchore/syft/releases/download/v1.51.1/syft_1.51.1_linux_amd64.tar.gz) |
...
| `grype` | `Application:         grype` | latest | https://github.com/anchore/grype | [`sha256:1d444c5e7360471815f7158f…`](https://github.com/anchore/grype/releases/download/v0.118.0/grype_0.118.0_linux_amd64.tar.gz) |
...
| `gh` | `gh version 2.100.0 (2026-09-03)` | latest | https://github.com/cli/cli | [`sha256:e4d4bb4498e8d007abe545b6…`](https://github.com/cli/cli/releases/download/v2.100.0/gh_2.100.0_linux_amd64.tar.gz) |
...
| `vault` | `Vault v2.1.0 (cb6a54face072e372480d7cc2e64a3110b84756f), built 2026-08-31T13:29:27Z` | latest | https://github.com/hashicorp/vault | [`sha256:08e8a13d29d20c5e28ef5e2c…`](https://releases.hashicorp.com/vault/2.1.0/vault_2.1.0_linux_amd64.zip) |
...
- redis-tools: `6:8.10.1-1rl1~trixie1`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260913.md
