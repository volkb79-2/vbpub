# Devcontainer Manifest — trixie-py3.14-php8.5-20260917

## Release

- Build date: `20260917`
- Built at (UTC): `2026-09-18T01:33:15Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260917`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260917
```
...
| `claude` | `2.1.275 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:13586f3150a7ca1655f36e1d…`](https://downloads.claude.ai/claude-code-releases/2.1.275/linux-x64/claude) |
...
| `reasonix` | `reasonix v1.38.9` | latest | https://github.com/reasonix/reasonix |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260917.md
