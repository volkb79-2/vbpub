# Devcontainer Manifest — trixie-py3.14-php8.5-20260731

## Release

- Build date: `20260731`
- Built at (UTC): `2026-07-31T01:36:53Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260731`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260731
```
...
| `antigravity` | `1.1.8` | latest | https://github.com/antigravity/antigravity-cli | [`sha256:e92e6215532b3ce84455e341…`](https://storage.googleapis.com/antigravity-public/antigravity-cli/1.1.8-5636713813508096/linux-x64/cli_linux_x64.tar.gz) |
...
| `copilot` | `GitHub Copilot CLI 1.0.77.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.7.1-2 (0790d9f)` | latest | https://github.com/openclaw/openclaw |  |
| `opencode` | `1.18.10` | latest | https://github.com/anomalyco/opencode |  |
| `reasonix` | `reasonix v1.18.0` | latest | https://github.com/reasonix/reasonix |  |
...
| `hadolint` | `Haskell Dockerfile Linter 2.15.0` | latest | https://github.com/hadolint/hadolint | [`sha256:eb8eb4dd06a068cce65cb847…`](https://github.com/hadolint/hadolint/releases/download/v2.15.0/hadolint-linux-x86_64) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260731.md
