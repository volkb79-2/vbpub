# Devcontainer Manifest — trixie-py3.14-20260710-2

## Release

- Build date: `20260710-2`
- Target: `unknown`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260710-2`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-20260710-2
```
...
| `antigravity` | `1.1.1` | latest | https://github.com/antigravity/antigravity-cli | `sha256:2ee167841cdc9a1d7dc5a624…` |
| `claude` | `2.1.206 (Claude Code)` | latest | https://github.com/anthropics/claude-code | `sha256:d131494be407ff56a62f4e99…` |
| `codex` | `codex-cli 0.144.1` | latest | https://github.com/openai/codex | `sha256:3fd50cf96809b1eea294bbfb…` |
...
| `opencode` | `1.17.18` | latest | https://github.com/anomalyco/opencode |  |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-20260710-2.md
