...
- Build date: `20260618-2`
- Target: `trixie-py311-vsc`
- Debian: `trixie`
- Python: `3.11`
- Immutable image tag: `trixie-py3.11-20260618-2`
- Floating image tag: `trixie-py3.11-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.11-20260618-2
```
...
- ciu `3.1.0` — sha256: `9d1fe2dc22b1a9ff3c141a15a3bdc2813a4d6151c5462d77564f50bfbcdabfd1`
- cmru `1.0.0` — sha256: `908587f8c377768f18340feb145c5b61e7e4bf54bdcf4d6bcb8479ee9014abca`
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.11-20260618-2.md
- Source tree: https://github.com/volkb79-2/vbpub/tree/main/modern-debian-tools-python-debug

## In-Image File

- Devcontainer manifest: `/home/vscode/devcontainer-manifest-trixie-py3.11-20260618-2.md`
...
- claude 2.1.181 (binary): sha256 `35ffd4e9d9a86395d0ba4e05f8b23bf098bfeab95e97deacd6537909d1324e9c`; source `https://downloads.claude.ai/claude-code-releases/2.1.181/linux-x64/claude`
- claude-manifest 2.1.181 (manifest): sha256 `e588f1d31051e529c533cba0388748c48b331aa467755957d98f5628716923de`; source `https://downloads.claude.ai/claude-code-releases/2.1.181/manifest.json`
- antigravity 1.0.9 (tar.gz): sha256 `cd80f85f43b52b389d7b498d6784f8316d57a9cc62eae23d840c5de368f9c4d5`; source `https://storage.googleapis.com/antigravity-public/antigravity-cli/1.0.9-6003845613092864/linux-x64/cli_linux_x64.tar.gz`
- antigravity-manifest 1.0.9 (manifest): sha256 `9ac57c0a78f225e7615cf0781d607dc44ac4d911af8eacd5dd642eb3a17b8844`; source `https://antigravity-cli-auto-updater-974169037036.us-central1.run.app/manifests/linux_amd64.json`
...
- awscli 2.35.8 (zip): sha256 `a73ad6cf15a8ce5986031013c6e788610d859e8d59b0823ed6108c45b4226776`; source `https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip`
