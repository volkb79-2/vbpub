# Devcontainer Manifest — trixie-py3.14-php8.5-20260716

## Release

- Build date: `20260716`
- Built at (UTC): `2026-07-16T00:12:14Z`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-php8.5-20260716`
- Floating image tag: `trixie-py3.14-php8.5-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-php8.5-20260716
```
...
| `claude` | `2.1.211 (Claude Code)` | latest | https://github.com/anthropics/claude-code | [`sha256:8272c8a474ac9ea1bc35f19b…`](https://downloads.claude.ai/claude-code-releases/2.1.211/linux-x64/claude) |
...
| `opencode` | `1.18.2` | latest | https://github.com/anomalyco/opencode |  |
...
| Tool | Version | Policy | Project Home | Package digest / source |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.35.24 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | [`sha256:d71b4388a3f9e2c56819de40…`](https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip) |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-php8.5-20260716.md
