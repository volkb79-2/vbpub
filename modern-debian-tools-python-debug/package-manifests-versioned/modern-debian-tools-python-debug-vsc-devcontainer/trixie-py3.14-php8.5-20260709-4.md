# Devcontainer Manifest — trixie-py3.14-20260709-4

## Release

- Build date: `20260709-4`
- Target: `unknown`
- Debian: `trixie`
- Python: `3.14`
- Immutable image tag: `trixie-py3.14-20260709-4`
- Floating image tag: `trixie-py3.14-latest`

## Pull

```bash
docker pull ghcr.io/volkb79-2/modern-debian-tools-python-debug-vsc-devcontainer:trixie-py3.14-20260709-4
```
...
| `antigravity` | `1.1.0` | latest | https://github.com/antigravity/antigravity-cli | `sha256:7ee512440af5ed0c819065cd…` |
| `claude` | `2.1.205 (Claude Code)` | latest | https://github.com/anthropics/claude-code | `sha256:dd8734c0b6a503fe1d174251…` |
| `codex` | `codex-cli 0.144.0` | latest | https://github.com/openai/codex | `sha256:6b03d2d89910874fa5be27b6…` |
| `copilot` | `GitHub Copilot CLI 1.0.69.` | latest | https://github.com/github/copilot-cli |  |
| `openclaw` | `OpenClaw 2026.6.11 (e085fa1)` | latest | https://github.com/openclaw/openclaw |  |
| `reasonix` | `reasonix v1.17.9` | latest | https://github.com/reasonix/reasonix |  |
...
| `dtop` | `dtop 0.7.8` | latest | https://github.com/amir20/dtop | `sha256:65e3aeaa044d4d50ca157b6d…` |
...
| Tool | Version | Policy | Project Home | Package digest |
|---|---|---|---|---|
| `awscli` | `aws-cli/2.35.20 Python/3.14.6 Linux/7.0.12+deb13-amd64 exe/x86_64.debian.13` | latest | https://github.com/aws/aws-cli | `sha256:a4aa00212a97e6a5abd38cde…` |
...
- This release page: https://github.com/volkb79-2/vbpub/blob/main/modern-debian-tools-python-debug/package-manifests-versioned/modern-debian-tools-python-debug-vsc-devcontainer/trixie-py3.14-20260709-4.md
