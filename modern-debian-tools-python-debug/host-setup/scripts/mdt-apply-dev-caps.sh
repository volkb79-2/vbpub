...
if command -v docker >/dev/null 2>&1 && docker info >/dev/null 2>&1; then
  ...
  # this sweep leaves transient IO properties unset rather than inventing a
  # host-independent cap that could stall an interactive container. Applies to
  # every category this sweep matches below (test-runner/"bench", buildkit,
