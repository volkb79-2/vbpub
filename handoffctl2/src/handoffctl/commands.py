...
Lets an operator drive handoffctl from the ntfy phone app by sending short
...
- Replies are PUBLISHED via the existing WRITE-ONLY publisher path
  ...
  topic, always tagged `handoffd-reply`. Any inbound message carrying that
