...
- `handoffctl lint` with L1–L12; golden corpus from the P69/P78/P84/P85
  incidents; pre-commit hook for carve commits.
- `handoffctl doctor`: read-only drift audit over in-place files (draft 1's
...
- `handoffctl status` (CLI table) and `render` (static www/: index, history,
