...
[SPEC](../../handoffctl/docs/SPEC.md) text applies with draft-2 storage
...
`handoffctl lint` MUST pass before a handoff may be committed/queued. Rules
...
6. Dogfood rule: handoffctl2's own implementation packages are carved, linted,
