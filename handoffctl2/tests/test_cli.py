...
def make_statefile():
    ...
    def _make(**kwargs):
        defaults = {
            ...
            "since": __import__("handoffctl.types", fromlist=["utc_now"]).utc_now(),
            "paused": False,
        }
...
def test_project_add(sample_project, tmp_state, capsys):
    ...
    from handoffctl import config, paths
...
def test_lint_all_clean(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.lint.lint_project", mock_lint_project)
...
def test_lint_specific_paths(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.lint.lint_file", mock_lint_file)
...
def test_doctor_clean(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.doctor.doctor_project", mock_doctor_project)
...
def test_doctor_rebuild(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.doctor.doctor_project", mock_doctor_project)
    monkeypatch.setattr("handoffctl.doctor.rebuild", mock_rebuild)
...
def test_status_one_task(sample_project, tmp_state, capsys, make_statefile, monkeypatch):
    ...
    attempt = Attempt(
        ...
        route=route,
        started=__import__("handoffctl.types", fromlist=["utc_now"]).utc_now(),
...
def test_render(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.render.render_all", mock_render_all)
...
def test_tick(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.daemon.run_once", mock_run_once)
...
def test_decide_success(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.decisions.decide", mock_decide)
...
def test_decide_error(sample_project, tmp_state, capsys, monkeypatch):
    ...
    from handoffctl import storage, decisions
...
def test_discuss(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.decisions.discuss", mock_discuss)
...
def test_leases_empty(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.leases.holder_info", mock_holder_info)
...
def test_digest(sample_project, tmp_state, capsys, monkeypatch):
    ...
    monkeypatch.setattr("handoffctl.notify.digest", mock_digest)
...
def test_version(capsys, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "handoffctl.daemon", None)
...
def test_decide_debug_reraises(sample_project, tmp_state, monkeypatch):
    ...
    from handoffctl import decisions
