...
(src/handoffctl/cli.py, PACKAGE P10) is explicitly OUT OF SCOPE for this
...
from handoffctl import config, daemon, lint, paths, reconcile, render, storage
...
def _project_toml_text(cfg) -> str:
    return (cfg.root / ".handoffctl" / "project.toml").read_text(encoding="utf-8")
