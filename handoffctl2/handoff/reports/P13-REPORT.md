...
- `src/handoffctl/render.py` — bug fix + SVG DAG layout + timeline auto-fit + live page rewrite (module docstring updated to match)
...
never has (confirmed in `src/handoffctl/types.py`; `hasattr(tsf, 'frontmatter')`
