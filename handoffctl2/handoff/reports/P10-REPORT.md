...
```
cd /workspaces/vbpub/handoffctl2 && /workspaces/vbpub/.venv/bin/python -m pytest tests/test_cli.py -q
.............................                                            [100%]
```

## Files Touched

- `/workspaces/vbpub/handoffctl2/src/handoffctl/cli.py` — implementation (main entry point + 14 subcommand handlers)
- `/workspaces/vbpub/handoffctl2/tests/test_cli.py` — comprehensive test suite (29 test cases)
...
- **Error handling**: catches HandoffctlError-family exceptions, prints "error: ..." to stderr (tracebacks only with `--debug`)
