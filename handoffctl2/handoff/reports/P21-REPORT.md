...
- `src/handoffctl/adapters.py` — `build_dispatch`'s prompt text: replaced
...
Command: `cd /workspaces/vbpub/.worktrees/handoffctl2-P21/handoffctl2 && PYTHONPATH=src /workspaces/vbpub/.venv/bin/python -m pytest tests/ -q`
