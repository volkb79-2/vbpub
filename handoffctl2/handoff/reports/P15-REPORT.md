...
- `src/handoffctl/daemon.py` — module docstring extended (P15 CONFIG-mutation
  ...
  'ui' — deliberately NOT `_append_ev`, which hardcodes actor TICK/'handoffd'
  ...
  new POST-only paths.
- `src/handoffctl/render.py` — module docstring extended (config.html
...
- `src/handoffctl/reconcile.py` — module docstring extended (pause-mode
...
- `src/handoffctl/commands.py` — module docstring extended (widened regex
...
- `src/handoffctl/config.py` — the two authorized additions:
...
```
cd /workspaces/vbpub/handoffctl2 && /workspaces/vbpub/.venv/bin/python -m pytest tests/test_config_ui.py -q
..............                                                           [100%]
14 passed in 3.63s
```
...
```
cd /workspaces/vbpub/handoffctl2 && /workspaces/vbpub/.venv/bin/python -m pytest -q
........................................................................ [ 20%]
........................................................................ [ 40%]
........................................................................ [ 61%]
........................................................................ [ 81%]
...
- **CLI `pause <project> [agents|handoffs]` (`src/handoffctl/cli.py`,
...
- **`update_routes`/`update_project_policy` accept only the exact anchor
  ...
  Every existing `.handoffctl/project.toml` / `routes.toml` in this repo's
