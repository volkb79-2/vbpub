...
> handoff/STANDING.md, docs/SPEC.md §14, src/handoffctl/{types,storage,
> leases}.py, src/handoffctl/wrapper.py docstring.
...
4. **Sequence integrity under concurrency**: multiprocessing, 4 processes
   × 25 append_event each (same project, HANDOFFCTL_STATE env inherited)
