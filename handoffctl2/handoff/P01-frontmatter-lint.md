...
> src/handoffctl/frontmatter.py + src/handoffctl/lint.py (docstrings = the
> normative interface), src/handoffctl/types.py, docs/SPEC.md §6,
> tests/conftest.py (SAMPLE_HANDOFF).

## Owned files
- `src/handoffctl/frontmatter.py`, `src/handoffctl/lint.py`
