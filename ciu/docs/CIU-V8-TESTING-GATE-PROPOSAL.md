...
**Proposal revision:** 3.3 (3.2 corrected in place; every rev 3.1 change is traced to a T-finding in §4.3.13 and §4.7 X57–X72, every rev 3.2 change to a T2-finding or an operator answer in §4.3.14 and §4.7 X73–X84, every rev 3.3 change to a T3-finding in §4.3.15 and §4.7 X85–X94)
**Updated:** 2026-09-03
