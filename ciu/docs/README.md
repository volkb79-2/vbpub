# CIU — Documentation Index

## Start here

| Document | Purpose |
|---|---|
| [FEATURES.md](FEATURES.md) | **Canonical feature list + CLI surface.** Capability matrix, current `ciu <verb>` reference, common workflows, and the edge cases worth knowing. |
...
| [../CHANGES.md](../CHANGES.md) | Release-by-release source history; future entries are generated by CMRU before the release gate. |
