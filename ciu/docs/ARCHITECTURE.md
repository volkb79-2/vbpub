...
| `worktree.py` | Git-worktree lifecycle, shared infrastructure, and cross-instance deployment budget | `add_worktree`, `remove_worktree`, `resolve_worktree_cap`, `worktree_budget_slot` | S16 | `test_ciu_worktree.py`, `test_ciu_engine_worktree_budget.py` |
