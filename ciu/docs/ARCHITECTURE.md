...
| `worktree.py` | Managed Git-worktree identity/state records, create/adopt/ensure/remove lifecycle, shared infrastructure, and cross-instance deployment budget | `create`, `adopt`, `ensure`, `remove`, `resolve_worktree_cap`, `worktree_budget_slot` | S16 | `test_ciu_worktree.py`, `test_ciu_engine_worktree_budget.py` |
