...
Last updated: 2026-08-12 (CIU-22 FIXED — code + tests + spec + docs,
`ciu-P02-worktree-shared-infra-join`, S16.1. Earlier the same day: CIU-20/21/23
FIXED, `ciu-P01-worktree-isolation-primitives`; CIU-26 filed as the deferred
real-Postgres proof for CIU-23's shipped provisioner. CIU-24/25 remain OPEN,
split out pending design — see `nyxloom-trove/backlog.md`).
