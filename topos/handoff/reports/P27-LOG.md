...
- Branch: feat/topos-p27-swap-refault-aliases
- Worktree: .worktrees/-topos-p27-swap-refault-aliases
- Base commit: e9ad906 (docs(topos): carve P27 swap refault aliases)
...
- Commands: git worktree add -b feat/topos-p27-swap-refault-aliases .worktrees/-topos-p27-swap-refault-aliases main
...
- Action: Created centralized alias module src/topos/ui/aliases.py
- Files changed: topos/src/topos/ui/aliases.py
...
- Files changed: topos/src/topos/ui/table.py
...
- Files changed: topos/src/topos/diag/score.py
...
- Files changed: topos/src/topos/diag/rules.py
...
- Files changed: topos/tests/test_aliases.py
...
- Commands: python3 -m pytest topos/tests/test_aliases.py -v
- Result: 20/20 passed
- Commands: python3 -m pytest topos/tests/test_ui_table.py topos/tests/test_diag.py -v
- Result: 19/19 passed (no regressions)

- Action: Updated documentation
- Files changed: topos/docs/COMPRESSED-SWAP.md, topos/README.md, topos/docs/ROADMAP.md, topos/docs/STATUS.md
...
- Files changed: topos/src/topos/ui/aliases.py, topos/src/topos/ui/table.py,
  topos/tests/test_aliases.py, topos/docs/COMPRESSED-SWAP.md,
  topos/docs/STATUS.md, topos/handoff/reports/P27-LOG.md,
  topos/handoff/reports/P27-REPORT.md.
...
- Commands: `git merge --no-ff feat/topos-p27-swap-refault-aliases -m "Merge topos P27 swap refault aliases"`,
  `PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests/test_aliases.py topos/tests/test_ui_table.py topos/tests/test_diag.py -q`,
  `PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m py_compile topos/src/topos/ui/aliases.py topos/src/topos/ui/table.py topos/src/topos/diag/score.py topos/src/topos/diag/rules.py topos/tests/test_aliases.py`,
  `PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests -q`.
- Files changed: topos/docs/STATUS.md, topos/handoff/reports/P27-LOG.md,
  topos/handoff/reports/P27-REPORT.md.
...
```bash
py_compile topos/src/topos/ui/aliases.py topos/src/topos/ui/table.py topos/src/topos/diag/score.py topos/src/topos/diag/rules.py topos/tests/test_aliases.py
# (no output — clean)

python3 -m pytest topos/tests/test_aliases.py -v
# 20 passed in 0.06s

python3 -m pytest topos/tests/test_ui_table.py topos/tests/test_diag.py -v
# 19 passed in 0.34s

python3 -m pytest topos/tests -q
# 201 passed in 28.69s

/tmp/p25-venv/bin/python -m pytest topos/tests/test_aliases.py topos/tests/test_ui_table.py topos/tests/test_diag.py -q
