...
### Diagnostics (`topos/src/topos/diag/__init__.py`)
...
```text
topos/tests/test_host_device.py::test_net_dev_counters_includes_drops_and_errors PASSED
topos/tests/test_host_device.py::test_apply_host_device_rates_computes_drop_error_rates PASSED
topos/tests/test_host_device.py::test_apply_host_device_rates_drop_error_reset_handled PASSED
topos/tests/test_ui_banner.py::test_banner_shows_loss_annotation_when_drops_nonzero PASSED
topos/tests/test_ui_banner.py::test_banner_shows_no_loss_annotation_when_all_zero PASSED
topos/tests/test_ui_banner.py::test_banner_loss_annotation_omits_none_values PASSED
topos/tests/test_ui_banner.py::test_banner_loss_annotation_ignores_malformed_rates PASSED
topos/tests/test_diag.py::test_annotate_adds_host_network_loss_finding PASSED
topos/tests/test_diag.py::test_annotate_no_host_network_loss_when_zero PASSED
topos/tests/test_diag.py::test_annotate_no_host_network_loss_when_no_meta PASSED
topos/tests/test_diag.py::test_annotate_preserves_existing_host_network_loss_when_no_meta PASSED
topos/tests/test_diag.py::test_annotate_host_network_loss_replaces_existing_finding PASSED
topos/tests/test_diag.py::test_annotate_host_network_loss_ignores_malformed_rates PASSED
```
...
| File | Change |
|---|---|
| `topos/src/topos/collect/host.py` | Extended `_net_dev_counters()` to parse `rx_errors`, `rx_drop`, `tx_errors`, `tx_drop` |
| `topos/src/topos/collect/collector.py` | Extended `_apply_host_device_rates()` to compute `rx_errors_s`, `rx_drops_s`, `tx_errors_s`, `tx_drops_s` |
| `topos/src/topos/ui/banner.py` | Added LOSS annotation to `_net_device_line()`, added `_fmt_loss_rate()` |
| `topos/src/topos/diag/__init__.py` | Added `_annotate_host_network_loss()`, wired into `annotate()`, with deduplication, replay preservation, and malformed metadata tolerance |
| `topos/tests/test_host_device.py` | Added 3 new tests, updated 4 existing tests for new fields |
| `topos/tests/test_ui_banner.py` | Added 4 new tests for LOSS annotation display and malformed-rate tolerance |
| `topos/tests/test_diag.py` | Added 6 new tests for host network loss finding behavior |
| `topos/tests/fixtures/frames/gstammtisch-once.jsonl` | Updated net_devices entry with new fields |
| `topos/docs/STATUS.md` | Updated diagnostics input notes |
| `topos/handoff/reports/P37-LOG.md` | Work log |
| `topos/handoff/reports/P37-REPORT.md` | This report |
