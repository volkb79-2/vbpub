...
**Base:** `b5ba9af` (docs(topos): carve P51 daemon sampling fanout)
**Date:** 2026-07-10
...
### `topos/src/topos/daemon/broker.py` — Refactored `FrameBroker`
...
### `topos/src/topos/cli.py` — Lifecycle Integration
...
### Tests — `topos/tests/test_daemon_p51.py`
...
- `topos/src/topos/daemon/broker.py`
- `topos/src/topos/daemon/__init__.py`
- `topos/src/topos/cli.py`
- `topos/tests/test_daemon_p51.py`
- `topos/tests/test_daemon_broker.py`
