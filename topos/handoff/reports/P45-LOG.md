...
- Branch: feat/topos-p45-inspect-files-bounded-content
- Worktree: .worktrees/-topos-p45-inspect-files-bounded-content
...
- Files: topos/src/topos/cli.py, topos/tests/test_inspect_files.py
- Result: `topos inspect-files read` no longer accepts --fixture-root.
...
- Files: topos/tests/fixtures/inspect_files/docker/containers/oversized/oversized-json.log
