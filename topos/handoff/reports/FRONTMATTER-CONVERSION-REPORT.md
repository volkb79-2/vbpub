# Frontmatter conversion report — topos OPEN handoffs → nyxloom

Converted the 11 named OPEN topos handoff files to nyxloom YAML frontmatter.
...
`topos-P89-source-auto-backfill` passes and also satisfies L1's
...
paraphrased resolution hint, I renamed files to `topos-P<NN>-<slug>` (project id as
...
| Old (in `topos/handoff/`) | New (in `topos/handoff/`) | id |
|---|---|---|
| `P89-source-auto-backfill.md` | `topos-P89-source-auto-backfill.md` | `topos-P89-source-auto-backfill` |
| `P90-bounded-process-sampler.md` | `topos-P90-bounded-process-sampler.md` | `topos-P90-bounded-process-sampler` |
| `P91-persistent-capped-history.md` | `topos-P91-persistent-capped-history.md` | `topos-P91-persistent-capped-history` |
| `P92-loopback-web-transport.md` | `topos-P92-loopback-web-transport.md` | `topos-P92-loopback-web-transport` |
| `P93-lifecycle-owner-protocol.md` | `topos-P93-lifecycle-owner-protocol.md` | `topos-P93-lifecycle-owner-protocol` |
| `P94-detail-observation-leases.md` | `topos-P94-detail-observation-leases.md` | `topos-P94-detail-observation-leases` |
| `P95-lifecycle-identity-incidents.md` | `topos-P95-lifecycle-identity-incidents.md` | `topos-P95-lifecycle-identity-incidents` |
| `P73-web-ui-read-only-shell.md` | `topos-P73-web-ui-read-only-shell.md` | `topos-P73-web-ui-read-only-shell` |
| `P77-web-ui-entity-detail.md` | `topos-P77-web-ui-entity-detail.md` | `topos-P77-web-ui-entity-detail` |
| `P64-report-baseline-regression-gate.md` | `topos-P64-report-baseline-regression-gate.md` | `topos-P64-report-baseline-regression-gate` |
| `P65-report-human-readable-render.md` | `topos-P65-report-human-readable-render.md` | `topos-P65-report-human-readable-render` |
...
|---|---|---|---|---|---|
| topos-P89-source-auto-backfill | sonnet5-high | resume:p88 | — | 7 | topos-suite, py-compile |
| topos-P90-bounded-process-sampler | sonnet5-high | fresh | — | 8 | topos-suite, py-compile |
| topos-P91-persistent-capped-history | sonnet5-high | fresh | — | 10 | topos-suite, py-compile |
| topos-P92-loopback-web-transport | sonnet5-high | fresh | topos-P91-persistent-capped-history | 9 | topos-suite, py-compile |
| topos-P93-lifecycle-owner-protocol | sonnet5-high | fresh | — | 11 | topos-suite, py-compile |
| topos-P94-detail-observation-leases | sonnet5-high | fresh | topos-P90-bounded-process-sampler | 12 | topos-suite, py-compile |
| topos-P95-lifecycle-identity-incidents | sonnet5-high | fresh | topos-P91-persistent-capped-history, topos-P93-lifecycle-owner-protocol | 10 | topos-suite, py-compile |
| topos-P73-web-ui-read-only-shell | sonnet5-high | fresh | topos-P89-source-auto-backfill, topos-P92-loopback-web-transport | 10 | topos-suite, py-compile |
| topos-P77-web-ui-entity-detail | sonnet5-high | resume:p73 | topos-P73-web-ui-read-only-shell | 11 | topos-suite, py-compile |
| topos-P64-report-baseline-regression-gate | flash-high | fresh | — | 9 | topos-suite, py-compile |
| topos-P65-report-human-readable-render | flash-high | fresh | — | 8 | topos-suite, py-compile |
...
- `mutexes` was left unset (schema default) — the legacy `Serialize-with:` hints
  ...
  no corresponding named mutex declared in `topos/.nyxloom/project.toml` (only
  `merge-lane` exists), and the brief did not ask for `mutexes` to be populated —
  so no mutex name was invented.
- `scope.touch` fell back to `["topos/**"]` / `forbid: []` uniformly. None of the
...
(schema-required) `topos-P89-...` filenames, the equivalent check is:

```
env PYTHONPATH=src /workspaces/vbpub/.venv/bin/python -m nyxloom.cli lint \
  ../topos/handoff/topos-P{89,90,91,92,93,94,95,73,77,64,65}-*.md
```
...
(merged-history) handoff files in `topos/handoff/` — expected and out of scope
for this task; not one of them references any of our 11 new filenames
(`grep -c "topos-P" full-lint-output` = 0).

## `tick --project topos` result

```
cd /workspaces/vbpub/nyxloom && env PYTHONPATH=src /workspaces/vbpub/.venv/bin/python -m nyxloom.cli tick --project topos
```

Output: `11` — one action per converted file. Confirmed via
`nyxloom.cli status --project topos` and
`~/.local/state/nyxloom/projects/topos/events.jsonl`: all 11 new task ids
...
- 11 converted+renamed files under `topos/handoff/` (see mapping table above).
- This report: `topos/handoff/reports/FRONTMATTER-CONVERSION-REPORT.md`.
