...
- Files changed: topos/tests/test_dockerjoin.py (new resolver tests),
  topos/tests/test_inspect_files.py (mutual exclusion tests),
  topos/tests/test_actions.py (mutual exclusion tests)
...
- Files changed: topos/handoff/reports/P57-SELFREVIEW.md, topos/handoff/reports/P57-REPORT.md, topos/handoff/reports/P57-LOG.md
...
- Decision: Use sys.exit(2) for error cases via return 2 from main handlers
  Reason: Matches existing topos exit code patterns (exit 2 for user errors).
...
```text
$ python3 -m pytest topos/tests/test_dockerjoin.py -v
...
$ python3 -m pytest topos/tests/test_inspect_files.py -v -k container
# 2 passed (plan_both_target_and_container_exit_2, read_both_target_and_container_exit_2)
$ python3 -m pytest topos/tests/test_actions.py -v -k container
# 2 passed (preview_both_target_and_container_exit_2, execute_both_target_and_container_exit_2)
$ python3 -m py_compile topos/src/topos/collect/dockerjoin.py
$ python3 -m py_compile topos/src/topos/cli.py
$ python3 -m py_compile topos/tests/test_dockerjoin.py
# All compile clean
$ python3 -m pytest topos/tests -q --ignore=topos/tests/test_ui_app.py --ignore=topos/tests/test_damon_paddr.py --ignore=topos/tests/test_damon_passive.py --ignore=topos/tests/test_p23_zram_drilldown.py
