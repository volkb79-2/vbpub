...
Added `topos/tests/test_packaging_metadata.py` with two tests that structurally
...
- `python3 -m build topos/` produced topos-0.1.0.tar.gz and topos-0.1.0-py3-none-any.whl.
...
Pip resolved Textual 8.2.8. `topos --version` verified (topos 0.1.0),
...
Clean exit across all topos/src/topos and topos/tests .py files.
