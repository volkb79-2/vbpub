...
- Branch: feat/topos-p71-zfs-arc-provider
- Worktree: .worktrees/topos-p71-zfs-arc-provider
...
- Commands: PYTHONPATH=topos/src python3 -c "from topos.registry import REGISTRY; print([k for k in REGISTRY if 'zfs' in k])"
- Files changed: src/topos/registry.py
...
- Files changed: src/topos/collect/host.py
...
- Files changed: tests/test_zfs_arc.py, src/topos/ui/banner.py
...
- Files changed: docs/ARCHITECTURE.md, topos/README.md, docs/ROADMAP.md, docs/STATUS.md, docs/COMPRESSED-SWAP.md
...
- Files changed: topos/handoff/reports/P71-LOG.md, topos/handoff/reports/P71-REPORT.md
...
```
$ PYTHONPATH=topos/src python3 -W ignore -m pytest topos/tests/test_zfs_arc.py -q -W ignore -v
topos/tests/test_zfs_arc.py ...........                                  [100%]
11 passed

$ python3 -m py_compile topos/src/topos/collect/host.py topos/src/topos/registry.py topos/src/topos/ui/banner.py
exit: 0
...
### Scope check
All 12 changed files are under `topos/`. No files outside `topos/**` touched.
...
```bash
PYTHONPATH=topos/src python3 -W ignore -m pytest topos/tests/test_zfs_arc.py -q -W ignore
# 11 passed
PYTHONPATH=topos/src python3 -W ignore -m pytest topos/tests/test_host_swap.py topos/tests/test_p23_zram_drilldown.py topos/tests/test_ui_banner.py topos/tests/test_zfs_arc.py topos/tests/test_collector.py -q -W ignore
# 47 passed
