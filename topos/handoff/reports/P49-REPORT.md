...
### New module: `topos/src/topos/actions/governance.py`
...
### Tests: `topos/tests/test_actions.py` — 69 new tests (200 total)
...
None. The governance module is additive and package-private (`topos/actions/`).
...
```bash
PYTHONPATH=topos/src python3 -m py_compile topos/src/topos/actions/governance.py \
  topos/src/topos/actions/catalog.py topos/src/topos/actions/preview.py \
  topos/src/topos/actions/execute.py topos/src/topos/actions/__init__.py \
