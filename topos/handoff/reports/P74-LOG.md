...
- Branch: feat/topos-p74-gpu-host-provider
- Worktree: /workspaces/vbpub/.worktrees/topos-p74-gpu-host-provider
- Base commit: main
...
- Files: src/topos/collect/host.py
...
- Commands: PYTHONPATH=src python3 -m topos.cli --once --json; py_compile on 4 files
...
PYTHONPATH=src python3 -m topos.cli --once --json | python3 -c "import sys,json; d=json.load(sys.stdin); print('GPU count:', d['host']['host_gpu_count'], 'VRAM:', d['host']['host_gpu_vram_total'], 'Busy:', d['host']['host_gpu_busy_pct'])"
