...
One new test file, `topos/tests/test_ui_ciu_grouped.py` (7 tests), that
drives a real `ToposApp` through Textual `pilot` keypresses into the
...
```
A  topos/tests/test_ui_ciu_grouped.py    # 7 pilot tests, 6 numbered oracles
A  topos/handoff/reports/P86-LOG.md      # Work log
A  topos/handoff/reports/P86-REPORT.md   # This report
```
