...
- Touch only `topos/**`
- Keep `topos/handoff/reports/P45-LOG.md` current
- Finish with `topos/handoff/reports/P45-REPORT.md` and focused commits

## Requirements

- Add a read API and `topos inspect-files read` CLI path gated by both
