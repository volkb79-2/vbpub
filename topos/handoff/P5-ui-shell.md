...
golden fixtures; live loop wiring finalized in P7). Branch: `feat/topos-p5-ui`.
...
- `topos` on fixture frames: banner verdict + top-pressure render; toggle,
  profiles, drill-down work; `topos --replay <golden>` plays through the SAME
  code path.
