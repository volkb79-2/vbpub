...
- Branch: `feat/topos-p47-daemon-component-health`
- Worktree: `.worktrees/-topos-p47-daemon-component-health`
- Touch only `topos/**`; write P47-LOG.md/P47-REPORT.md; commit, do not merge.
...
- Add a read-only protocol request and `topos daemon health [--json]`; version
