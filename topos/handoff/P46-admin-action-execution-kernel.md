...
- Touch only `topos/**`
- Keep `topos/handoff/reports/P46-LOG.md` current
- Finish with `topos/handoff/reports/P46-REPORT.md` and focused commits

## Requirements

- Add an execution module and `topos action execute` CLI path. Preserve
