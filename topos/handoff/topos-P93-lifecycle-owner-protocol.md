---
schema_version: 1
id: topos-P93-lifecycle-owner-protocol
project: topos
...
- **Worktree:** create a git worktree for branch `feat/topos-p93-lifecycle-owner-protocol`
  at `.worktrees/topos-p93-lifecycle-owner-protocol` (repo-root-relative, per
