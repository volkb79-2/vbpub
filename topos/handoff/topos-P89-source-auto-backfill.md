---
schema_version: 1
id: topos-P89-source-auto-backfill
project: topos
...
- **Worktree:** create a git worktree for branch `feat/topos-p89-source-auto-backfill`
  at `.worktrees/topos-p89-source-auto-backfill` (repo-root-relative, per
  `worktree_root` in `topos/.nyxloom/project.toml`) from `main`; do all
  implementation work there, never in the primary checkout.
- **Branch:** `feat/topos-p89-source-auto-backfill`
