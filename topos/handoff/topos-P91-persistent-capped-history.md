---
schema_version: 1
id: topos-P91-persistent-capped-history
project: topos
...
- **Worktree:** create a git worktree for branch `feat/topos-p91-persistent-capped-history`
  at `.worktrees/topos-p91-persistent-capped-history` (repo-root-relative, per
