---
schema_version: 1
id: topos-P65-report-human-readable-render
project: topos
...
- **Worktree:** create a git worktree for branch `feat/topos-p65-report-human-readable-render`
  at `.worktrees/topos-p65-report-human-readable-render` (repo-root-relative, per
