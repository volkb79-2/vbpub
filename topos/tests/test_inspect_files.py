...
def _check_no_subprocess_in_modules() -> None:
    ...
    for mod_name in ("topos.inspect_files.catalog", "topos.inspect_files.__init__", "topos.inspect_files.plan"):
...
class TestCliIntegration:
    ...
    def test_parse_inspect_files_args_plan(self) -> None:
        from topos.cli import parse_inspect_files_args
...
class TestReadDisabled:
    ...
    def test_read_without_inspect_files_returns_denied(self) -> None:
        from topos.inspect_files.reader import ReadDenied, build_inspect_read
    ...
    def test_read_denied_json_no_content(self) -> None:
        ...
        from topos.inspect_files.reader import ReadDenied
...
class TestReadContent:
    ...
    def test_docker_log_read_success(self) -> None:
        from topos.inspect_files.reader import InspectFilesReadResult, build_inspect_read
        cid = "a" * 64
        result = build_inspect_read(
            "docker-json-log", cid,
    ...
    def test_docker_log_oversized_file(self) -> None:
        ...
        from topos.inspect_files.reader import InspectFilesReadError
...
class TestReadSafety:
    ...
    def test_no_subprocess_import_in_reader(self) -> None:
        ...
        spec = importlib.util.find_spec("topos.inspect_files.reader")
    ...
    def test_no_arbitrary_path_escape_docker(self) -> None:
        ...
        from topos.inspect_files.reader import InspectFilesReadError, build_inspect_read
...
class TestP45BoundedContentCorrections:
    ...
    def test_fixture_root_alone_does_not_bypass_root(self, monkeypatch) -> None:
        ...
        from topos.inspect_files.reader import InspectFilesReadError, build_inspect_read
        monkeypatch.setattr("topos.inspect_files.reader.os.geteuid", lambda: 1000)
        result = build_inspect_read(
            "docker-json-log", "a" * 64,
            inspect_files=True, admin=True,
            fixture_root=self.FIXTURE_ROOT / "docker",
    ...
    def test_confine_and_open_no_follow_leaf_symlink(self, tmp_path: Path) -> None:
        ...
        from topos.inspect_files.reader import _confine_and_open
        from pathlib import Path
        import pytest
    ...
    def test_rendered_bound_counts_utf8_bytes_and_generated_lines(self) -> None:
        ...
        from topos.inspect_files.reader import _bound_rendered_text
    ...
    def _make_runner(
        ...
        def _runner(
            ...
            *,
            ...
            from topos.inspect_files.reader import _JournaldRunResult
