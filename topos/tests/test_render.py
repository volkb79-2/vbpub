"""Tests for topos.render — P65 human-readable query/report rendering.

Numbered acceptance oracles (handoff topos-P65-report-human-readable-render.md):
...
from topos.query import Caps, MetricRef, Query, Selector, run_query
...
class TestJsonRemainsByteCompatible:
    def test_query_json_matches_direct_format_result(self, tmp_path):
        from topos.query import format_result
...
class TestRendererPurity:
    def test_no_file_io_in_render_module(self):
        import topos.render as render_module
