...
from topos.actions.preview import (
    ActionPlan,
    DisabledPlan,
    build_preview,
    build_admin_preview,
...
def _check_no_subprocess_in_modules() -> None:
    ...
    for mod_name in (
        "topos.actions.catalog",
        "topos.actions.preview",
        "topos.actions.audit",
    ):
...
class TestCliIntegration:
    ...
    def test_parse_action_args_preview(self) -> None:
        from topos.cli import parse_action_args
...
class TestTargetValidation:
    ...
    def test_validate_target(self, kind, target, should_pass) -> None:
        from topos.actions.execute import validate_target
...
class TestExecutionResultRendering:
    ...
    def test_result_to_jsonable(self) -> None:
        from topos.actions.execute import ExecuteResult, result_to_jsonable
    ...
    def test_render_result_text(self) -> None:
        from topos.actions.execute import ExecuteResult, render_result_text
...
class TestExecutionAllowlistExclusion:
    ...
    def test_set_property_not_in_execution_allowlist(self) -> None:
        from topos.actions.catalog import EXECUTION_ALLOWLIST, ActionKind
...
class TestOutputBounding:
    ...
    def test_short_output_passes_through(self) -> None:
        from topos.actions.execute import _bound_output

        assert _bound_output("hello") == "hello"

    def test_long_output_is_truncated(self) -> None:
        from topos.actions.execute import _bound_output, _MAX_OUTPUT_CHARS
...
class TestP46ControllerSecurityCorrections:
    ...
    def test_missing_gate_does_not_touch_audit_or_runner(
        ...
        called = []
        result = __import__(
            "topos.actions.execute", fromlist=["execute_plan"]
        ).execute_plan(
            "docker-start",
            "c1",
            admin=admin,
    ...
    def test_missing_and_default_audit_are_fail_closed(self, tmp_path: Path) -> None:
        from topos.actions.execute import DEFAULT_EXECUTION_AUDIT_PATH, execute_plan
    ...
    def test_audit_identity_is_stable_and_confirmation_is_not_logged(
        ...
        from topos.actions.execute import AuditIdentity, execute_plan
...
class TestMemoryHighValueValidation:
    ...
    def test_valid_values(self, value: str) -> None:
        from topos.actions.governance import validate_memory_high_value
...
class TestMemoryHighUnitValidation:
    ...
    def test_valid_units(self, unit: str) -> None:
        from topos.actions.governance import validate_memory_high_unit
...
class TestPersistenceDetection:
    ...
    def test_scope_defaults_to_runtime(self) -> None:
        from topos.actions.governance import detect_default_persistence
    ...
    def test_validate_persistence_mode(self, mode: str, expected: str) -> None:
        from topos.actions.governance import validate_persistence_mode
...
class TestBuildSetPropertyArgv:
    ...
    def test_persistent_mode(self) -> None:
        from topos.actions.governance import build_set_property_argv, SYSTEMCTL_EXECUTABLE
    ...
    def test_rejects_wrong_property(self) -> None:
        from topos.actions.governance import build_set_property_argv
...
class TestSetPropertyPreview:
    ...
    def test_preview_with_current_value_reader(self) -> None:
        from topos.actions.governance import build_set_property_preview
    ...
    def test_render_preview(self) -> None:
        from topos.actions.governance import build_set_property_preview, render_set_property_preview
    ...
    def test_plan_to_jsonable(self) -> None:
        from topos.actions.governance import build_set_property_preview, set_property_plan_to_jsonable
...
class TestExecuteSetProperty:
    ...
    def test_success_path(self, tmp_path: Path) -> None:
        from topos.actions.execute import execute_set_property, ExecuteResult
