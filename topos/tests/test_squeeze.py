"""Tests for ``topos squeeze`` guided memory measurement.
...
class TestCliSqueezeArgs:
    ...
    def test_defaults(self) -> None:
        from topos.cli import parse_squeeze_args
    ...
    def test_admin_required_by_gate(self, tmp_path: Path) -> None:
        ...
        from topos.actions.squeeze import SqueezeConfig
...
class TestSqueezeAudit:
    ...
    def test_no_subprocess_import(self) -> None:
        ...
        spec = importlib.util.find_spec("topos.actions.squeeze")
