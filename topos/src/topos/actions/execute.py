...
from topos.actions.preview import ActionPlan, build_preview


DEFAULT_EXECUTION_AUDIT_PATH = Path("/var/log/topos/actions.jsonl")
_MIN_TIMEOUT = 0.001
_MAX_TIMEOUT = 30.0
...
def _default_current_value_reader(unit: str) -> str | None:
    ...
    """
    from topos.actions.governance import _systemctl_show_reader
...
def _make_plan_stub(kind: str, target: str, argv: tuple[str, ...]) -> ActionPlan:
    ...
    from topos.actions.preview import ActionPlan
