...
from topos.model import EntityFrame, Frame, MetricValue
...
def render_banner(frame: Frame, config: ToposConfig, *, collapsed: bool = False) -> BannerSnapshot:
...
def _host_verdict(frame: Frame, config: ToposConfig) -> str:
