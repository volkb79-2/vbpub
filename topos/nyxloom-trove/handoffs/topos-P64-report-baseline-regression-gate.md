---
schema_version: 1
id: topos-P64-report-baseline-regression-gate
project: topos
...
- **Worktree:** create a git worktree for branch `feat/topos-p64-report-baseline-regression-gate`
  at `.worktrees/topos-p64-report-baseline-regression-gate` (repo-root-relative, per
  `worktree_root` in `topos/.nyxloom/project.toml`) from `main`; do all
  implementation work there, never in the primary checkout.
- **Branch:** `feat/topos-p64-report-baseline-regression-gate`
