...
- Branch: `feat/topos-p41-rendered-replay-fidelity`
- Worktree: `.worktrees/-topos-p41-rendered-replay-fidelity`
- Touch only `topos/**`
- Keep `topos/handoff/reports/P41-LOG.md` current
- Finish with `topos/handoff/reports/P41-REPORT.md` and focused commits
...
- Full suite using `PYTHONPATH=topos/src /home/vscode/.venv/bin/python`.
