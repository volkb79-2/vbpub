...
`feat/topos-p21-admin-action-gating`. Follow `topos/README.md` workflow
protocol.
...
1. Add an action planning module, preferably under `topos/src/topos/actions/`,
...
- `topos action preview --kind docker-restart --target example --admin --json`
...
- `topos/handoff/reports/P21-LOG.md`
- `topos/handoff/reports/P21-REPORT.md`
