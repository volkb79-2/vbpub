...
- Touch only `topos/**`
- Keep `topos/handoff/reports/P35-LOG.md` updated while working
- Finish with `topos/handoff/reports/P35-REPORT.md` and a focused commit
...
- `topos/MEASUREMENTS.md` with the steady command as the preferred rootless
  collector evidence path before the final live TUI run.
- `topos/docs/OPERATIONS.md` with a short command example.
- `topos/docs/STATUS.md` acceptance notes if appropriate.
