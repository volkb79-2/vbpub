...
Self-review pass #1 per `topos/README.md`'s standing template. The
...
| Gate | Command | Result |
|---|---|---|
| Focused P76 tests with -W error | `PYTHONPATH=topos/src /usr/local/py-utils/venvs/pytest/bin/python -m pytest topos/tests/test_ciu_metadata.py -q -W error` | 55 passed |
| Full suite (relevant) with -W error | Same interpreter, `topos/tests/test_ciu_metadata.py topos/tests/test_dockerjoin.py topos/tests/test_model_registry.py topos/tests/test_collector.py` | 72 passed |
| py_compile all changed files | `python3 -m py_compile topos/src/topos/collect/dockerjoin.py topos/src/topos/model.py topos/src/topos/config.py topos/tests/test_ciu_metadata.py` | No output |
...
**PASS.** All 11 files are under `topos/**`:

- `topos/src/topos/collect/dockerjoin.py` — extension point
- `topos/src/topos/collect/collector.py` — wiring (self-review fix)
- `topos/src/topos/model.py` — CiuMeta dataclass
- `topos/src/topos/config.py` — CiuConfig
- `topos/tests/test_ciu_metadata.py` — tests
- `topos/tests/fixtures/frames/gstammtisch-once.jsonl` — regenerated golden
- `topos/CONTRACTS.md`, `topos/docs/ARCHITECTURE.md` — docs updates
- `topos/docs/STATUS.md`, `topos/docs/ROADMAP.md` — status updates
- `topos/handoff/reports/P76-LOG.md`, `topos/handoff/reports/P76-REPORT.md`

Nothing outside `topos/**`. Handoff scope: "Touch only `topos/**`; write
...
**PASS.**
- `topos/handoff/reports/P76-LOG.md` — present, follows AGENT-LOG-TEMPLATE.md
- `topos/handoff/reports/P76-REPORT.md` — present, follows P71-REPORT.md pattern
