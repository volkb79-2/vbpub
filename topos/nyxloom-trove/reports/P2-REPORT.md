...
- Added `src/topos/record/writer.py`:
...
- Added `src/topos/record/reader.py`:
...
- Added `src/topos/record/ring.py`:
...
```sh
PYTHONPATH=/tmp/topos-pytest:/tmp/vbpub-topos-p2-record/topos/src python3 -m pytest /tmp/vbpub-topos-p2-record/topos/tests -q
```
...
```sh
PYTHONPATH=/tmp/vbpub-topos-p2-record/topos/src python3 -m py_compile $(find /tmp/vbpub-topos-p2-record/topos/src/topos -name '*.py' | sort)
```
...
```sh
PYTHONPATH=/tmp/vbpub-topos-p2-record/topos/src python3 -m topos.cli --replay /tmp/vbpub-topos-p2-record/topos/tests/fixtures/frames/gstammtisch-once.jsonl --step
```
