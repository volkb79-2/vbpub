...
- Commands: PYTHONPATH=topos/src python3 -c "from topos.registry import ..."
...
- Commands: python -m pytest topos/tests/test_collector.py -q (6 passed)
...
- Commands: python -m pytest topos/tests/test_p55_filtering.py -q (31 passed)
- Files changed: topos/tests/test_p55_filtering.py
