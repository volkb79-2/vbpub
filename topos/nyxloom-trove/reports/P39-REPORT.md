...
`topos/docs/RELEASE-READINESS.md`. It distinguishes implemented fixture-tested
...
`topos/handoff/P40-textual-8-test-compatibility.md`; README and ROADMAP mark it
planned.
