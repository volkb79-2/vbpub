...
- **Package:** P72
- **Worktree:** `.worktrees/topos-p72-admin-action-kill-update`
- **Branch:** `feat/topos-p72-admin-action-kill-update`
- **Base:** main@27e0a6a
...
| File | Change |
|---|---|
| `topos/src/topos/actions/catalog.py` | Add DOCKER_KILL, SYSTEMD_KILL, DOCKER_UPDATE kinds, builders, EXECUTION_ALLOWLIST update, validate_target extension |
| `topos/src/topos/actions/kill_ops.py` | New module: signal validation, KillPlan, preview/execute support |
| `topos/src/topos/actions/update_ops.py` | New module: memory/CPU validation, UpdatePlan, systemd target check |
| `topos/src/topos/actions/preview.py` | KillPlan/UpdatePlan in union type, build_admin_preview extension |
| `topos/src/topos/actions/execute.py` | execute_kill, execute_update functions |
| `topos/src/topos/actions/__init__.py` | Export new symbols |
| `topos/src/topos/cli.py` | kill/update CLI arguments and routing |
| `topos/tests/test_actions.py` | Update EXECUTION_ALLOWLIST expected value |
| `topos/tests/test_p72_kill_update.py` | New file: 45 acceptance oracle tests |
