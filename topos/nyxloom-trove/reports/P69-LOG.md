...
- `topos/docs/WEB-UI-SCOPING.md`
- `topos/docs/DECISIONS-INBOX.md`
- `topos/handoff/reports/P69-LOG.md`
- `topos/handoff/reports/P69-REPORT.md`
...
1. **PROCESS VIOLATION — IMPLEMENTER PROMOTED DECISIONS-INBOX ENTRIES.** I
   created `topos/docs/DECISIONS-INBOX.md` and D-001--D-003 myself. Although the
...
2. **Fixed a false packaging claim.** The initial framework table said an
   optional `topos[web]` extra could ship same-distribution static assets
   without growing plain `pip install topos`. Extras select dependencies, not
...
- Commit `edbf698` contains exactly four added files, all under
  `topos/docs/**` or `topos/handoff/**`; no source, framework, dependency, pin,
