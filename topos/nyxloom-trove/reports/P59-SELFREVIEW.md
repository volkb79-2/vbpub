...
| File | In Scope? | Note |
|---|---|---|
| `topos/src/topos/cli.py` | ✅ | Handoff §27, Requirement 6 |
| `topos/src/topos/collect/collector.py` | ✅ | Handoff §32-33, Requirement 2 |
| `topos/tests/test_p59_container_selector.py` | ✅ | New test file per handoff acceptance oracles |
| `topos/README.md` | ✅ | Handoff §107 |
| `topos/CONTRACTS.md` | ✅ | Handoff §108 |
| `topos/docs/ROADMAP.md` | ✅ | Handoff §109 |
| `topos/docs/STATUS.md` | ✅ | Handoff §109 |
| `topos/handoff/reports/P59-LOG.md` | ✅ | Self-referencing (package log) |
| `topos/handoff/reports/P59-REPORT.md` | ✅ | Self-referencing (package report) |
