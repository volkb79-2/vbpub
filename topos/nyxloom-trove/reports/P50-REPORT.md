...
| Branch | `feat/topos-p50-mouse-table-interactions` |
| Status | **Done** |
...
```
PYTHONPATH=topos/src python -m pytest topos/tests/test_ui_app.py -k p50 -q
# 12 passed, 23 deselected in 4.93s (controller review)

PYTHONPATH=topos/src python -m pytest topos/tests -q
