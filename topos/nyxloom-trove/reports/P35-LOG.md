...
- Branch: feat/topos-p35-acceptance-steady
- Worktree: .worktrees/-topos-p35-acceptance-steady
...
- Commands: git worktree add -b feat/topos-p35-acceptance-steady .worktrees/-topos-p35-acceptance-steady main
- Files changed: N/A
- Result: Branch created at base commit 3965ab4
- Follow-up: Extend acceptance.py with run_steady

2026-07-10 UTC (continued)
- Action: Extended topos/src/topos/acceptance.py with steady subcommand, run_steady(), SteadyResult, format_steady_text/json, acceptance_main dispatcher
- Commands: multi_edit, python3 -m topos.acceptance steady --cgroup-root ... --samples 2 --interval-s 0
...
2026-07-10 UTC (continued)
- Action: Added 11 steady tests to topos/tests/test_acceptance.py (7 unit + 4 subprocess)
- Commands: pytest topos/tests/test_acceptance.py -v
...
- Commands: py_compile, pytest topos/tests -q (ignoring pre-existing UI test failures)
- Files changed: N/A
...
- Files changed: topos/src/topos/acceptance.py, topos/tests/test_acceptance.py, topos/handoff/reports/P35-LOG.md, topos/handoff/reports/P35-REPORT.md
...
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests/test_acceptance.py -q -> 26 passed in 4.54s
...
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests -q -> 316 passed in 38.85s
...
- Files changed: topos/README.md, topos/docs/ROADMAP.md, topos/docs/STATUS.md, topos/MEASUREMENTS.md, topos/handoff/reports/P35-REPORT.md, topos/handoff/reports/P35-LOG.md
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests/test_collector.py::test_golden_jsonl_frame_matches_fixture topos/tests/test_host_device.py topos/tests/test_ui_banner.py topos/tests/test_p23_zram_drilldown.py topos/tests/test_acceptance.py -q -> 64 passed in 5.42s
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m py_compile topos/src/topos/collect/host.py topos/src/topos/collect/collector.py topos/src/topos/ui/banner.py topos/src/topos/acceptance.py topos/tests/test_collector.py topos/tests/test_host_device.py topos/tests/test_ui_banner.py topos/tests/test_p23_zram_drilldown.py topos/tests/test_acceptance.py -> clean
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m pytest topos/tests -q -> 336 passed in 41.41s
- Validation: PYTHONPATH=topos/src /tmp/p25-venv/bin/python -m topos.acceptance steady --cgroup-root topos/tests/fixtures/cgroupfs/gstammtisch --samples 2 --interval-s 0 --json -> exit 0, ok true, samples 2/2
...
PYTHONPATH=topos/src python3 -m topos.acceptance steady --cgroup-root topos/tests/fixtures/cgroupfs/gstammtisch --samples 2 --interval-s 0 --json
# {"ok": true, "samples_completed": 2, ...} exit=0

# CPU threshold failure
PYTHONPATH=topos/src python3 -m topos.acceptance steady --cgroup-root topos/tests/fixtures/cgroupfs/gstammtisch --samples 2 --interval-s 0 --max-cpu-pct 0.0001
# exit=1

# Invalid args
PYTHONPATH=topos/src python3 -m topos.acceptance steady --cgroup-root topos/tests/fixtures/cgroupfs/gstammtisch --samples -1 --interval-s 0
# exit=2

# Full non-UI suite
PYTHONPATH=topos/src /home/vb/volkb79-2/vbpub/.venv/bin/python -m pytest topos/tests -q --ignore=topos/tests/test_ui_app.py --ignore=topos/tests/test_ui_table.py --ignore=topos/tests/test_ui_banner.py --ignore=topos/tests/test_aliases.py --ignore=topos/tests/test_damon_paddr.py --ignore=topos/tests/test_damon_passive.py --ignore=topos/tests/test_io_cap_saturation.py --ignore=topos/tests/test_p23_zram_drilldown.py
