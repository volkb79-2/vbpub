...
- Created centralized alias module `topos/src/topos/ui/aliases.py` with:
...
- Wired `resolve_column()` into every consumer function in `topos/src/topos/ui/table.py`:
...
- Updated diagnostic wording in `topos/src/topos/diag/score.py`:
...
- Updated finding wording in `topos/src/topos/diag/rules.py`:
...
```bash
python3 -m py_compile topos/src/topos/ui/aliases.py topos/src/topos/ui/table.py topos/src/topos/diag/score.py topos/src/topos/diag/rules.py topos/tests/test_aliases.py
# (no output — clean)
...
```bash
git merge --no-ff feat/topos-p27-swap-refault-aliases -m "Merge topos P27 swap refault aliases"
```
...
- Feature commit(s) on `feat/topos-p27-swap-refault-aliases`.
- Pre-merge validation:
  - `python3 -m pytest topos/tests/test_aliases.py -v` → `20 passed in 0.06s`
  - `python3 -m pytest topos/tests/test_ui_table.py topos/tests/test_diag.py -v` → `19 passed in 0.34s`
  - `python3 -m pytest topos/tests -q` → `201 passed in 28.69s`
